...
D.\t$40^{888}$。 
    ...
    },
    {
        ...
        difficulty: 1,
        content: `若 $\\dfrac{a}{x} + \\dfrac{b}{y} = 3$，則 $x =$
<div class="q-mcopt">
A.\t$\\dfrac{ay}{3y-b}$。 <br>
B.\t$\\dfrac{ay}{b-3y}$。 <br>
C.\t$\\dfrac{by}{3y-a}$。 <br>
...
D.\t$0.076540$（準確至五位小數）。 
    ...
    },
    {
        ...
        difficulty: 1,
        content: `若 $4\\alpha + \\beta = 7\\alpha + 3\\beta = 5$，則 $\\beta =$
<div class="q-mcopt">
A.\t$-3$。 <br>
B.\t$-2$。 <br>
C.\t$2$。 <br>
D.\t$3$。 
    ...
    },
    {
        ...
        difficulty: 1,
        content: `設 $\\mathrm{f}(x) = 4x^3 + kx + 3$，其中 $k$ 為一常數。 若 $\\mathrm{f}(x)$ 可被 $2x+1$ 整除，求當 $\\mathrm{f}(x)$ 除以 $x+1$ 時的餘數。 
<div class="q-mcopt">
A.\t$-7$<br>
B.\t$-6$<br>
C.\t$0$<br>
D.\t$5$
    ...
    },
    {
        ...
        difficulty: 2,
        content: `$-5x > 21 - 2x$  及  $6x - 18 < 0$  的解為
<div class="q-mcopt">
A.\t$x \\lt -7$。 <br>
B.\t$x \\lt 3$。 <br>
C.\t$-7 \\lt x \\lt 3$。 <br>
D.\t$x \\lt -7$  或  $x \\gt 3$。 
    ...
    },
    {
        ...
        difficulty: 1,
        content: `若 $k$ 為一常數使得二次方程 $x^2 + kx + 8k + 36 = 0$ 有等根，則 $k =$
<div class="q-mcopt">
A.\t$-6$。 <br>
B.\t$12$。 <br>
C.\t$-4$  或  $36$。 <br>
D.\t$-18$  或  $2$。 
    ...
    },
    {
        ...
        difficulty: 2,
        content: `若 $-1 \\lt a \\lt 0$，則下列何者可表示 $y = (ax + 1)^2 + a$ 的圖像？
<div class="q-mcopt">
...
<img src="img/2016dsep2q09C.jpg" class="q-img" alt="題目附圖" style="display: inline-block; vertical-align: top; max-width: 35%;">\t\t<img src="img/2016dsep2q09D.jpg" class="q-img" alt="題目附圖" style="display: inline-block; vertical-align: top; max-width: 35%;">
    ...
    },
    {
        ...
        topic: ["Percentages"],
        difficulty: 2,
        content: `<u>漢林</u>的月薪較<u>文俊</u>高 $25\\%$，而<u>文俊</u>的月薪較<u>佩怡</u>低 $25\\%$。 已知<u>漢林</u>的月薪為 $\\$33\\,360$，<u>佩怡</u>的月薪為
<div class="q-mcopt">
A.\t$\\$31\\,275$。 <br>
B.\t$\\$33\\,360$。 <br>
C.\t$\\$35\\,584$。 <br>
D.\t$\\$52\\,125$。 
    ...
    },
    {
        ...
        difficulty: 1,
        content: `若 $x$ 及 $y$ 均為非零的數使得 $(3y-4x):(2x+y)=5:6$，則 $x:y=$
<div class="q-mcopt">
A.\t$7:8$。 <br>
B.\t$8:29$。 <br>
C.\t$9:32$。 <br>
D.\t$13:34$。 
    ...
    },
    {
        ...
        topic: ["Variations"],
        difficulty: 2,
        content: `已知 $z$ 隨 $\\sqrt{x}$ 正變且隨 $y$ 反變。 若 $x$ 減少 $36\\%$ 且 $y$ 增加 $60\\%$，則 $z$
<div class="q-mcopt">
A.\t增加 $24\\%$。 <br>
B.\t增加 $28\\%$。 <br>
C.\t減少 $40\\%$。 <br>
...
D.\t只有 II 及 III
    ...
    },
    {
        ...
        difficulty: 1,
        content: `圖中，$ABC$ 為一直線。 若 $AB=24\\text{ cm}$ 、 $AD=40\\text{ cm}$ 、 $BD=32\\text{ cm}$ 及 $CD=68\\text{ cm}$，則 $BC=$
...
D.\t$60\\text{ cm}$。 
    ...
    },
    {
        ...
        topic: ["Geometry (Polygons)"],
        difficulty: 2,
        content: `圖中，$ABCD$ 為一平行四邊形。 $E$ 為 $CD$ 上的一點使得 $BE=CE$。 若 $\\angle ADC=114^\\circ$，則 $\\angle ABE=$
...
D.\t只有 II 及 III
    ...
    },
    {
        ...
        difficulty: 2,
        content: `圖中，$ABCD$、$CDEF$ 及 $EFGH$ 均為正方形。 $AG$ 分別與 $CD$ 及 $EF$ 相交於 $P$ 及 $Q$。 求四邊形 $DEQP$ 的面積與四邊形 $ABCP$ 的面積之比。 
...
D.\t$AB \\sin a + BC \\sin c$。
    ...
    },
    {
        ...
        difficulty: 2,
        content: `圖中，$ABCD$ 為一菱形。 $C$ 為圓 $BDE$ 的圓心且 $ADE$ 為一直線。 $BE$ 與 $CD$ 相交於 $F$。 若 $\\angle ADC = 118^\\circ$，則 $\\angle DFE =$
...
D.\t$87^\\circ$。
    ...
    },
    {
        ...
        topic: ["Geometry (Polygons)"],
        difficulty: 1,
        content: `下面的圖形包含八個完全相同的正六邊形。 該圖形的反射對稱軸的數目為
...
D.\t$8$。
    ...
    },
    {
        ...
        topic: ["Geometry (Polygons)"],
        difficulty: 2,
        content: `若一正 $n$ 邊形的內角和為 $3\\,240^\\circ$，則下列何者正確？
<div class="q-mcopt">
A.\t$n$ 的值為 $16$。 <br>
...
D.\t該多邊形的每一內角均為 $160^\\circ$。 
    ...
    },
    {
        ...
        difficulty: 2,
        content: `若直線 $hx+ky+15=0$ 與直線 $4x+3y-5=0$ 互相垂直且相交於 $x$ 軸上的一點，則 $k=$
<div class="q-mcopt">
A.\t$-12$。 <br>
B.\t$-4$。 <br>
C.\t$3$。 <br>
D.\t$16$。 
    ...
    },
    {
        ...
        difficulty: 2,
        content: `點 $A$ 及點 $B$ 的坐標分別為 $(9,-2)$ 及 $(-1,8)$。 若 $C$ 為直線 $x-2y=0$ 上的一點使得 $AC=BC$，則 $C$ 的 $x$ 坐標為
<div class="q-mcopt">
A.\t$1$。 <br>
B.\t$2$。 <br>
C.\t$3$。 <br>
D.\t$4$。 
        ...
        hint: `$AC=BC$ 表示 $AB$ 的垂直平分線與已知直線的交點。 `,
        solution: `B (36%)`
    },
    {
        ...
        difficulty: 2,
        content: `圓 $C$ 的方程為 $3x^2+3y^2-12x+30y+65=0$。 下列何者正確？
<div class="q-mcms">
I.\t$C$ 的半徑為 $14$。
II.\t原點位於 $C$ 以外。
III.\t$C$ 的圓心的坐標為 $(2,-5)$。
...
D.\tI、II 及 III
    ...
    },
    {
        ...
        topic: ["Probability"],
        difficulty: 2,
        content: `<u>潔儀</u>的口袋內有一個 $\\$1$ 硬幣、一個 $\\$2$ 硬幣、一個 $\\$5$ 硬幣及一個 $\\$10$ 硬幣。 若<u>潔儀</u>從她的口袋中隨機取出三個硬幣，求她取得至少 $\\$13$ 的概率。 
<div class="q-mcopt">
A.\t$\\dfrac{1}{2}$<br>
B.\t$\\dfrac{1}{4}$<br>
C.\t$\\dfrac{3}{4}$<br>
...
D.\t$93$。 
    ...
    },
    {
        ...
        difficulty: 2,
        content: `$9a^2b$、$12a^4b^3$ 及 $15a^6$ 的 L.C.M. 為
<div class="q-mcopt">
A.\t$3a^2$。 <br>
B.\t$3a^2b$。 <br>
C.\t$180a^6b^3$。 <br>
D.\t$180a^{12}b^4$。 
    ...
    },
    {
        ...
        difficulty: 2,
        content: `圖中的圖像顯示 $x$ 與 $\\log_9 y$ 之間的線性關係。 若 $y=ab^x$，則 $b=$
...
D.\t$205 \\times 16^{12} + 239 \\times 16^{7}$。 
    ...
    },
    {
        ...
        difficulty: 2,
        content: `設 $u = \\dfrac{7}{a+i}$ 及 $v = \\dfrac{7}{a-i}$，其中 $a$ 為一實數。 下列何者必為正確？
<div class="q-mcms">
I.\t$uv$ 為一有理數。
II.\t$u$ 的實部等於 $v$ 的實部。
...
D.\t只有 II 及 III
    ...
    },
    {
        ...
        difficulty: 2,
        content: `圖中，$PQ$ 及 $SR$ 均平行於 $x$ 軸。 若 $(x, y)$ 為陰影區域 $PQRS$（包括邊界在內）中的一點，則 $7y-5x+3$ 於哪一點達至其最大值？
...
D.\t$S$
    ...
    },
    {
        ...
        topic: ["Sequences"],
        difficulty: 2,
        content: `設 $a_n$ 為一等比數列的第 $n$ 項。 若 $a_3 = 21$ 及 $a_7 = 189$，則下列何者必為正確？
<div class="q-mcms">
I.\t該數列的公比小於 $1$。
II.\t該數列的某些項為無理數。
...
D.\t只有 II 及 III
    ...
    },
    {
        ...
        difficulty: 2,
        content: `設 $a$ 及 $b$ 均為常數。 若圖中所示為 $y = a \\cos 2x^\\circ$ 的圖像，則
...
D.\t$a = 2$  及  $b = 360$。 
    ...
    },
    {
        ...
        topic: ["Trigonometric Ratios"],
        difficulty: 2,
        content: `當 $0^\\circ \\le \\theta \\le 360^\\circ$ 時，方程 $5 \\sin^2 \\theta + \\sin \\theta - 4 = 0$ 有多少個根？
<div class="q-mcopt">
A.\t$2$<br>
B.\t$3$<br>
C.\t$4$<br>
D.\t$5$
    ...
    },
    {
        ...
        difficulty: 2,
        content: `圖中，$ABCDEFGH$ 為一長方體。 $AC$ 與 $BD$ 相交於 $P$。 $Q$ 為 $CH$ 上的一點使得 $CQ = 9\\text{ cm}$ 及 $QH = 15\\text{ cm}$。 求 $\\sin \\angle PFQ$。 
...
D.\t$\\dfrac{58}{13\\sqrt{181}}$
    ...
    },
    {
        ...
        difficulty: 2,
        content: `圖中，$AC$ 為圓 $ABCD$ 的一直徑。 $PB$ 及 $PD$ 均為該圓的切線。 $AD$ 的延線與 $BC$ 的延線相交於 $Q$。 若 $\\angle BPD = 68^\\circ$，則 $\\angle AQB =$
...
D.\t$34^\\circ$。 
    ...
    },
    {
        ...
        difficulty: 2,
        content: `直線 $2x-y-6=0$ 與圓 $x^2+y^2-8y-14=0$ 相交於 $P$ 及 $Q$。 求 $PQ$ 的中點的 $y$ 坐標。 
<div class="q-mcopt">
A.\t$-4$<br>
B.\t$-2$<br>
C.\t$2$<br>
D.\t$4$
    ...
    },
    {
        ...
        topic: ["Probability"],
        difficulty: 2,
        content: `某箱子內有 $9$ 罐咖啡及 $3$ 罐紅茶。 若從該箱子中隨機取出 $4$ 罐，求取出至少 $2$ 罐紅茶的概率。 
<div class="q-mcopt">
A.\t$\\dfrac{13}{55}$<br>
B.\t$\\dfrac{21}{55}$<br>
C.\t$\\dfrac{34}{55}$<br>
D.\t$\\dfrac{42}{55}$
    ...
    },
    {
        ...
        difficulty: 2,
        content: `某班有 $20$ 名男生及 $15$ 名女生。 若從該班中選出 $6$ 名學生組成一個至多有 $2$ 名女生的委員會，則可組成多少個不同的委員會？
<div class="q-mcopt">
A.\t$271\\,320$<br>
B.\t$324\\,415$<br>
C.\t$508\\,725$<br>
...
D.\t只有 II 及 III
    ...
    },
    {
        ...
        difficulty: 2,
        content: `某組數的方差為 $49$。 將該組的每個數乘以 $4$ 後各加上 $9$ 而成新一組數。 求新一組數的方差。 
<div class="q-mcopt">
A.\t$196$<br>
B.\t$205$<br>
C.\t$784$<br>
