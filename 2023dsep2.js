...
D.\t$\\dfrac{5b^2+13b}{4+b}$。
        ...
        hint: `交叉相乘後整理含 $a$ 的項。`,
        solution: `C (78%)<p><iframe src="https://www.youtube.com/embed/oOzYNlK8iSo?autoplay=0&rel=0" title="解題影片" style="align: center; max-width: 100%; max-height: 1600px; aspect-ratio: 16/9;" allow="clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen></iframe>`
    },
    {
