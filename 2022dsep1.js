...
questions.push(
    ...
    },
    {
        ...
        difficulty: 3,
        content: `圖中，$A$ 是位於四邊形 $BCDE$ 以內的一點使得 $AC // ED$ 及 $AD /// BC$。 已知 $\\angle ABC = \\angle AED$ 及 $AB = AE$。<img src="img/2022dsep1q08.jpg" class="q-img" alt="題目附圖" style="max-width: 70%; margin-left: 15px; margin-bottom: 5px;"><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">證明 $\\Delta ABC \\cong \\Delta AED$。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">若 $\\angle ABC = 39^\\circ$ 及 $\\angle DAE = 87^\\circ$，求 $\\angle ACD$。<span class="marks">(3分)</span><div class="q-clearfix"></div></div></div>`,
