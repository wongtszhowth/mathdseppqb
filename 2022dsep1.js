...
questions.push(
    ...
    },
    {
        ...
        topic: ["Variations"],
        difficulty: 3,
        content: `已知 $\\mathrm{f}(x)$ 的一部分隨 $x$ 正變，而另一部分則隨 $x$ 正變。 假定 $\\mathrm{f}(4)=96$ 及 $\\mathrm{f}(-5)=15$。<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $f(x)$。<span class="marks">(3分)</span></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">寫出 $y=8\\mathrm{f}(x)$ 的圖像的 $x$ 截距。<span class="marks">(1分)</span></div></div><div class="q-line"><span class="q-label">(c)</span><div class="q-text-content">設 $k$ 為一實常數。 求 $k$ 值的範圍使得方程 $\\mathrm{f}(x)=k$ 有兩個相異的實根。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
