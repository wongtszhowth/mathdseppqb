...
D.\t$2x^2 + 18y^2$.
        ...
        hint: {
          tc: `應用平方差公式或展開後簡化。`,
          en: `Apply the difference of squares formula or expand and simplify.`
        },
...
D.\t$\\dfrac{32}{\\alpha^2}$.
        ...
        hint: {
          tc: `先處理負指數，再合併同類項。`,
          en: `First handle the negative indices, then combine like terms.`
        },
...
D.\t$\\dfrac{2(n-k)}{5}$.
        ...
        hint: {
          tc: `先移項再倒數求解 $m$。`,
          en: `First move terms and then take the reciprocal to solve for $m$.`
        },
...
D.\t$18.2482$ (correct to 4 decimal places).
        ...
        hint: {
          ...
          en: `Calculate the approximate value of $\\sqrt{333}$ and compare with the precision of each option.`
        },
...
D.\t$\\$84$.
        ...
        hint: {
          tc: `設未知數後解聯立方程。`,
          en: `Introduce unknowns and solve the simultaneous equations.`
        },
...
D.\t$80$
        ...
        hint: {
          tc: `設總人數後列方程求解。`,
          en: `Let the total number of students be a variable and set up an equation.`
        },
...
D.\tis decreased by $80\\%$.
        ...
        hint: {
          ...
          en: `Write $z = k\\dfrac{x^2}{y}$ and calculate the ratio of the new value to the old value.`
        },
...
D.\t$72^\\circ$.
        ...
        hint: {
          tc: `由弧長及面積公式求半徑及圓心角。`,
          en: `Use the arc length and area formulae to find the radius and the central angle.`
        },
...
D.\t$60\\text{ cm}$.
        ...
        hint: {
          tc: `利用體積比及高之比求半徑比。`,
          en: `Use the volume ratio and the height ratio to find the ratio of the radii.`
        },
...
D.\t$45\\text{ cm}^2$.
        ...
        hint: {
          tc: `利用相似三角形或面積比關係。`,
          en: `Use similar triangles or area ratio relationships.`
        },
...
D.\t$180\\text{ cm}$
        ...
        solution: `C (52%)<p><iframe src="https://www.youtube.com/embed/placeholder18?autoplay=0&rel=0" title="解題影片" loading="lazy" style="max-width: 100%; max-height: 40vh; aspect-ratio: 16/9;" allow="clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen></iframe>`
    },
    {
...
D.\t$p+q+r-s=540^\\circ$
        ...
        solution: `C (48%)<p><iframe src="https://www.youtube.com/embed/placeholder19?autoplay=0&rel=0" title="解題影片" loading="lazy" style="max-width: 100%; max-height: 40vh; aspect-ratio: 16/9;" allow="clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen></iframe>`
    },
    {
...
D.\tII and III only
        ...
        hint: {
          tc: `先求邊數，再判斷各性質。`,
          en: `First find the number of sides, then check each property.`
        },
        solution: `D (51%)<p><iframe src="https://www.youtube.com/embed/placeholder20?autoplay=0&rel=0" title="解題影片" loading="lazy" style="max-width: 100%; max-height: 40vh; aspect-ratio: 16/9;" allow="clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen></iframe>`
    },
    {
        ...
        difficulty: 3,
        content: {
          tc: `圖中，$ABCD$ 為一菱形。 將 $AC$ 與 $BD$ 的交點記為 $E$。 設 $F$ 為一點使得 $BH//EF$ 且 $CFHG$ 為一長方形，其中 $G$ 及 $H$ 分別為 $AC$ 的延線上及 $BC$ 的延線上的點。 將 $CD$ 與 $EF$ 的交點記為 $I$。 下列何者必為正確？
<div class="q-mcms"><img src="img/2024dsep2q21.jpg" class="q-img" alt="題目附圖" style="float: right; max-width: 55%; margin-left: 15px; margin-bottom: 5px;">
I.\t$CI=FI$
...
D.\tI, II and III
        ...
        solution: `A (32%)<p><iframe src="https://www.youtube.com/embed/placeholder21?autoplay=0&rel=0" title="解題影片" loading="lazy" style="max-width: 100%; max-height: 40vh; aspect-ratio: 16/9;" allow="clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen></iframe>`
    },
    {
        ...
        difficulty: 2,
        content: {
          tc: `圖中，$PQRS$ 為一梯形且 $PQ//SR$。 若 $PS = 10\\text{ cm}$ 、 $QR = 17\\text{ cm}$ 、 $\\angle PSR = 120^\\circ$ 及 $\\angle QRS = 135^\\circ$，則 $PQ =$
<div class="q-mcopt">
A.\t$15\\text{ cm}$。<br>
B.\t$18\\text{ cm}$。<br>
C.\t$21\\text{ cm}$。<br>
D.\t$24\\text{ cm}$。
          ...
          en: `In the figure, $PQRS$ is a trapezium with $PQ//SR$. If $PS = 10\\text{ cm}$, $QR = 17\\text{ cm}$, $\\angle PSR = 120^\\circ$ and $\\angle QRS = 135^\\circ$, then $PQ =$
<div class="q-mcopt">
A.\t$15\\text{ cm}$.<br>
B.\t$18\\text{ cm}$.<br>
C.\t$21\\text{ cm}$.<br>
D.\t$24\\text{ cm}$.
        ...
        hint: {
          tc: `作高並用餘弦定理。`,
          en: `Draw the heights and use the cosine rule.`
        },
        solution: `C (41%)<p><iframe src="https://www.youtube.com/embed/placeholder22?autoplay=0&rel=0" title="解題影片" loading="lazy" style="max-width: 100%; max-height: 40vh; aspect-ratio: 16/9;" allow="clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen></iframe>`
    },
    {
        ...
        difficulty: 2,
        content: {
          tc: `圖中，$O$ 為圓的圓心。 若 $\\angle AOB = 80^\\circ$ 及 $\\angle OCB = 35^\\circ$，則 $\\angle BAC =$
<div class="q-mcopt"><img src="img/2024dsep2q23.jpg" class="q-img" alt="題目附圖" style="float: right; max-width: 45%; margin-left: 15px; margin-bottom: 5px;">
A.\t$25^\\circ$。<br>
B.\t$30^\\circ$。<br>
C.\t$35^\\circ$。<br>
D.\t$40^\\circ$。
</div><div style="clear: both;"></div>`,
          en: `In the figure, $O$ is the centre of the circle. If $\\angle AOB = 80^\\circ$ and $\\angle OCB = 35^\\circ$, then $\\angle BAC =$
<div class="q-mcopt"><img src="img/2024dsep2q23.jpg" class="q-img" alt="題目附圖" style="float: right; max-width: 45%; margin-left: 15px; margin-bottom: 5px;">
A.\t$25^\\circ$.<br>
B.\t$30^\\circ$.<br>
C.\t$35^\\circ$.<br>
D.\t$40^\\circ$.
        ...
        hint: {
          tc: `利用圓周角及等腰三角形性質。`,
          en: `Use the angle at the centre and the properties of isosceles triangles.`
        },
        solution: `A (58%)<p><iframe src="https://www.youtube.com/embed/placeholder23?autoplay=0&rel=0" title="解題影片" loading="lazy" style="max-width: 100%; max-height: 40vh; aspect-ratio: 16/9;" allow="clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen></iframe>`
    },
    {
        ...
        difficulty: 2,
        content: {
          tc: `點 $A$ 及點 $B$ 的坐標分別為 $(1, 2)$ 及 $(5, 8)$。 若點 $P$ 在 $AB$ 上使得 $AP:PB = 1:3$，則 $P$ 的坐標為
<div class="q-mcopt">
A.\t$(2, 3.5)$。<br>
B.\t$(2, 3.5)$。<br>
C.\t$(4, 6.5)$。<br>
D.\t$(4, 6.5)$。
          ...
          en: `The coordinates of the points $A$ and $B$ are $(1, 2)$ and $(5, 8)$ respectively. If the point $P$ lies on $AB$ such that $AP:PB = 1:3$, then the coordinates of $P$ are
<div class="q-mcopt">
A.\t$(2, 3.5)$.<br>
B.\t$(2, 3.5)$.<br>
C.\t$(4, 6.5)$.<br>
D.\t$(4, 6.5)$.
        ...
        hint: {
          tc: `用分點公式。`,
          en: `Use the section formula.`
        },
        solution: `A (72%)<p><iframe src="https://www.youtube.com/embed/placeholder24?autoplay=0&rel=0" title="解題影片" loading="lazy" style="max-width: 100%; max-height: 40vh; aspect-ratio: 16/9;" allow="clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen></iframe>`
    },
    {
        ...
        difficulty: 2,
        content: {
          tc: `將原點記為 $O$。 點 $A$ 的坐標為 $(3, 4)$。 設 $P$ 為直角坐標平面上的一動點使得 $AP = 2OP$。 $P$ 的軌跡為一
<div class="q-mcopt">
A.\t點。<br>
B.\t圓。<br>
C.\t直線。<br>
D.\t拋物線。
          ...
          en: `Denote the origin by $O$. The coordinates of the point $A$ are $(3, 4)$. Let $P$ be a moving point in the rectangular coordinate plane such that $AP = 2OP$. The locus of $P$ is a
<div class="q-mcopt">
A.\tpoint.<br>
B.\tcircle.<br>
C.\tstraight line.<br>
D.\tparabola.
        ...
        hint: {
          tc: `寫出距離方程並化簡。`,
          en: `Write the distance equation and simplify.`
        },
        solution: `B (61%)<p><iframe src="https://www.youtube.com/embed/placeholder25?autoplay=0&rel=0" title="解題影片" loading="lazy" style="max-width: 100%; max-height: 40vh; aspect-ratio: 16/9;" allow="clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen></iframe>`
    },
    {
        ...
        difficulty: 2,
        content: {
          tc: `直線 $L_1$ 的方程為 $2x-3y+6=0$。 若直線 $L_2$ 平行於 $L_1$ 且通過點 $(1, -2)$，則 $L_2$ 的方程為
<div class="q-mcopt">
A.\t$2x-3y-8=0$。<br>
B.\t$2x-3y+4=0$。<br>
C.\t$3x+2y-1=0$。<br>
D.\t$3x+2y+1=0$。
          ...
          en: `The equation of the straight line $L_1$ is $2x-3y+6=0$. If the straight line $L_2$ is parallel to $L_1$ and passes through the point $(1, -2)$, then the equation of $L_2$ is
<div class="q-mcopt">
A.\t$2x-3y-8=0$.<br>
B.\t$2x-3y+4=0$.<br>
C.\t$3x+2y-1=0$.<br>
D.\t$3x+2y+1=0$.
        ...
        hint: {
          tc: `兩直線平行時斜率相等。`,
          en: `When two straight lines are parallel, their slopes are equal.`
        },
        solution: `B (69%)<p><iframe src="https://www.youtube.com/embed/placeholder26?autoplay=0&rel=0" title="解題影片" loading="lazy" style="max-width: 100%; max-height: 40vh; aspect-ratio: 16/9;" allow="clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen></iframe>`
    },
    {
...
D.\t只有 II 及 III
          ...
          en: `Denote the circle $3x^2+3y^2-6x+12y-4=0$ by $C$. Which of the following is/are true?
<div class="q-mcms">
I.\tThe origin lies inside $C$.
II.\t$C$ cuts the $x$-axis at two points.
III.\tThe radius of $C$ is $2$.
</div>
<div class="q-mcopt">
A.\tI only<br>
B.\tII only<br>
...
D.\tII and III only
        ...
        solution: `A (47%)<p><iframe src="https://www.youtube.com/embed/placeholder27?autoplay=0&rel=0" title="解題影片" loading="lazy" style="max-width: 100%; max-height: 40vh; aspect-ratio: 16/9;" allow="clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen></iframe>`
    },
    {
...
D.\t$\\dfrac{8}{15}$
          ...
          en: `Two numbers are randomly drawn at the same time from six cards numbered $1$, $2$, $3$, $4$, $5$ and $6$ respectively. Find the probability that the product of the two numbers drawn is not less than $12$.
<div class="q-mcopt">
A.\t$\\dfrac{1}{3}$<br>
B.\t$\\dfrac{2}{5}$<br>
C.\t$\\dfrac{7}{15}$<br>
D.\t$\\dfrac{8}{15}$
        ...
        hint: {
          tc: `列出所有組合後計算符合條件的數目。`,
          en: `List all combinations and count those that satisfy the condition.`
        },
        solution: `C (64%)<p><iframe src="https://www.youtube.com/embed/placeholder28?autoplay=0&rel=0" title="解題影片" loading="lazy" style="max-width: 100%; max-height: 40vh; aspect-ratio: 16/9;" allow="clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen></iframe>`
    },
    {
        ...
        difficulty: 2,
        content: {
          tc: `下面的框線圖顯示一群小童在某遊戲中所獲代幣的數目的分佈。 若該分佈的分佈域為其四分位數間距的三倍，求 $m$。
<div class="q-mcopt"><img src="img/2024dsep2q29.jpg" class="q-img" alt="題目附圖" style="float: right; max-width: 55%; margin-left: 15px; margin-bottom: 5px;">
A.\t$12$<br>
B.\t$15$<br>
C.\t$18$<br>
D.\t$21$
</div><div style="clear: both;"></div>`,
          en: `The box-and-whisker diagram below shows the distribution of the numbers of tokens got by a group of children in a certain game. If the range of the distribution is three times its inter-quartile range, find $m$.
<div class="q-mcopt"><img src="img/2024dsep2q29.jpg" class="q-img" alt="題目附圖" style="float: right; max-width: 55%; margin-left: 15px; margin-bottom: 5px;">
A.\t$12$<br>
B.\t$15$<br>
C.\t$18$<br>
D.\t$21$
        ...
        solution: `B (57%)<p><iframe src="https://www.youtube.com/embed/placeholder29?autoplay=0&rel=0" title="解題影片" loading="lazy" style="max-width: 100%; max-height: 40vh; aspect-ratio: 16/9;" allow="clipboard-write; encrypted-media; picture-in-picture; web-share" allowfullscreen></iframe>`
    },
    {
...
D.\tI、II 及 III
          ...
          en: `Consider the following positive integers:<div style="text-align: center;">$5$　$5$　$5$　$6$　$9$　$9$　$11$　$13$　$m$　$n$</div>Denote the standard deviation, the mode and the median of the above positive integers by $p$, $q$ and $r$ respectively. If the mean of the above positive integers is $7$, which of the following must be true?
<div class="q-mcms">
I.\t$p>3$
II.\t$q=5$
III.\t$r<7$
...
D.\t$192 \\times 16^{12} + 205$.
        ...
        hint: {
          ...
          en: `Convert the highest and lowest digits from hexadecimal to decimal.`
        },
...
D.\t$3$ or $8$.
        ...
        hint: {
          ...
          en: `Let $t=\\log_2 y$ and solve the quadratic equation.`
        },
...
D.\t$5$。
          ...
          en: `Let $z=(a-5)i+\\dfrac{(a+2)i}{2+i}$. If $a$ and $z$ are both real numbers, then $a-z=$
<div class="q-mcopt">
A.\t$2$.<br>
B.\t$3$.<br>
C.\t$4$.<br>
...
D.\tI、II 及 III
          ...
          en: `The sum of the first $n$ terms of a sequence is $n(2n+3)$. Which of the following is/are true?
<div class="q-mcms">
...
D.\t$78^\\circ$.
        ...
        hint: {
          tc: `利用切線與弦的夾角及圓周角性質。`,
          en: `Use the alternate segment theorem and properties of angles in the same segment.`
        },
...
D.\t$6$
        ...
        hint: {
          ...
          en: `Factorize and consider the range of $\\cos\\theta$.`
        },
...
D.\t$\\dfrac{\\sqrt{3}}{6}$.
        ...
        hint: {
          tc: `設邊長並用餘弦定理。`,
          en: `Let the side lengths be variables and use the cosine rule.`
        },
...
D.\tI、II 及 III
          ...
          en: `Let $G$, $H$, $I$ and $J$ be the centroid, the orthocentre, the in-centre and the circumcentre of $\\Delta PQR$ respectively. If $\\angle PQR = \\angle PRQ = 22^\\circ$, which of the following is/are true?
<div class="q-mcms">
...
D.\t$362~880$
          ...
          en: `2 managers and 7 officers stand in a line. If no two managers stand next to each other, how many different lines can be formed?
<div class="q-mcopt">
A.\t$80~640$<br>
B.\t$141~120$<br>
C.\t$282~240$<br>
...
D.\t$0.976$
          ...
          en: `A test consists of three questions. The probabilities that a certain student answers the first question, the second question and the third question correctly are $0.6$, $0.7$ and $0.8$ respectively. Find the probability that the student answers at least $1$ question correctly in this test.
<div class="q-mcopt">
A.\t$0.024$<br>
B.\t$0.188$<br>
C.\t$0.812$<br>
...
D.\t只有 II 及 III
          ...
          en: `In a certain examination, the scores (in marks) of the candidates are as follows:<div style="text-align: center;">$39$　$10$　$13$　$16$　$17$　$19$　$25$　$26$　$28$　$30$　$30$　$32$</div>Which of the following is/are true?
<div class="q-mcms">
I.\tThe median of the examination scores of these candidates is $22$ marks.
II.\tThe standard score of each candidate in this examination is less than $2$.
III.\tThe standard deviation of the examination scores of these candidates exceeds $8$ marks.
</div>
<div class="q-mcopt">
A.\tI only<br>
B.\tII only<br>
...
D.\t$144$.
        ...
        hint: {
          tc: `方差乘以 $9^2$，標準差再乘 $9$。`,
          en: `The variance is multiplied by $9^2$, and the standard deviation is then multiplied by $9$.`
        },
