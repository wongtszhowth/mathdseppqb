...
questions.push(
    ...
    },
    {
        ...
        solution: `<div class="ms-container"><div class="ms-row" style="white-space: pre; overflow-x: visible; overflow-y: visible;"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2" style="white-space: pre; overflow-x: visible; overflow-y: visible; grid-column: 2 / 6;">留意 $J$ 為圓 $OPQ$ 的圓心。<br>$\\angle IPO=\\angle JPQ$\t\t\t[$\\Delta$內心]<br>再者留意 $P$、$I$ 與 $J$ 共線。<br>$\\angle JPO=\\angle JPQ$<br>$JO=JP$\t\t\t\t\t[半徑]<br>$\\angle JOP=\\angle JPO$\t\t\t[等腰 $\\Delta$ 底角]<br>$JP=JQ$\t\t\t\t\t[半徑]<br>$\\angle JPQ=\\angle JQP$\t\t\t[等腰 $\\Delta$ 底角]<br>$\\angle JOP=\\angle JQP$<br>$JP=JP$\t\t\t\t\t[公共邊]<br>$\\Delta JOP\\cong\\Delta JQP$\t\t\t(AAS)<br>因此，可得 $OP=PQ$。\t[全等 $\\Delta$ 的對應邊]</div><div class="ms-mark"></div></div><p><div class="ms-row" style="white-space: pre; overflow-x: visible; overflow-y: visible;"><div class="ms-content ms-from-l2" style="white-space: pre; overflow-x: visible; overflow-y: visible; grid-column: 2 / 6;"><span style="background-color: #42b4ff;">另解 1：</span><br>留意 $J$ 為圓 $OPQ$ 的圓心。<br>$\\angle IPO = \\angle IPQ$\t\t\t\t[$\\Delta$內心]<br>再者留意 $P$、$I$ 與 $J$ 共線。<br>$\\angle JPO = \\angle JPQ$<br>$JP = JQ$\t\t\t\t\t\t[半徑]<br>$\\angle JQP = \\angle JPQ$\t\t\t\t[等腰 $\\Delta$ 底角]<br>            $= \\angle JPO$<br>$2\\angle POQ = \\angle PJQ$\t\t\t\t[圓心角兩倍於圓周角]<br>              $= 180^\\circ - \\angle JPQ - \\angle JQP$\t[$\\Delta$內角和]<br>              $= 180^\\circ - \\angle JPQ - \\angle JPO$<br>              $= \\angle POQ + \\angle OQP$\t\t[$\\Delta$內角和]<br>$\\angle POQ = \\angle OQP$<br>因此，可得 $OP = PQ$ 。\t\t[等角對邊相等]</div></div><p><div class="ms-row" style="white-space: pre; overflow-x: visible; overflow-y: visible;"><div class="ms-content ms-from-l2" style="white-space: pre; overflow-x: visible; overflow-y: visible; grid-column: 2 / 6;"><span style="background-color: #42b4ff;">另解 2：</span><br>留意 $J$ 為圓 $OPQ$ 的圓心。<br>$\\angle IPO = \\angle IPQ$\t\t\t[$\\Delta$內心]<br>再者留意 $P$、$I$ 與 $J$ 共線。<br>$\\angle JPO = \\angle JPQ$<br>$JO = JP$\t\t\t\t\t[半徑]<br>$\\angle JOP = \\angle JPO$\t\t\t[等腰 $\\Delta$ 底角]<br>$JP = JQ$\t\t\t\t\t[半徑]<br>$\\angle JPQ = \\angle JQP$\t\t\t[等腰 $\\Delta$ 底角]<br>$\\angle JOP = \\angle JQP$<br>$JO = JQ$\t\t\t\t\t[半徑]<br>$\\angle JOQ = \\angle JQO$\t\t\t[等腰 $\\Delta$ 底角]<br>$\\angle JOP - \\angle JOQ = \\angle JQP - \\angle JQO$<br>$\\angle POQ = \\angle OQP$<br>因此，可得 $OP = PQ$ 。\t[等角對邊相等]</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l2" style="border:1px solid #555555; padding:2px 4px; border-right: none; white-space: pre; overflow-x: auto;">評分標準：<br>情況 1\t附有正確理由的任何正確證明。<br>情況 2\t未附有理由的任何正確證明。<br>情況 3\t附有一正確理由和一正確步驟之未完整的證明。</div><div class="ms-mark" style="border:1px solid #555555; padding:2px 4px; border-left: none;"><br>3<br>2<br>1</div></div><p><div class="ms-row"><div class="ms-num1">(b)</div><div class="ms-num2">(i)</div><div class="ms-content ms-from-l3">設 $(h,19)$ 為 $P$ 的坐標。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">藉 (a)，可得 $h^2+19^2=(40-h)^2+(30-19)^2$。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">求解後，可得 $h=17$。</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">設 $x^2+y^2+Dx+Ey+F=0$ 為 $C$ 的方程。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">由於 $C$ 通過原點，可得 $F=0$。</div><div class="ms-mark">1A</div></div><div class="ms-row"><div class="ms-content ms-from-l3">故此，可得  $17D+19E+650=0$  及  $40D+30E+2\\,500=0$ 。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">求解後，可得  $D=-112$  及  $E=66$ 。</div><div class="ms-mark">1A</div></div><div class="ms-row"><div class="ms-content ms-from-l3">因此，$C$ 的方程為 $x^2+y^2-112x+66y=0$。</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-num2">(ii)</div><div class="ms-content ms-from-l3">留意 $L_1$ 的方程及 $L_2$ 的方程均為 $y=\\dfrac{3}{4}x+c$ 的形式，其中 $c$ 為一常數。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">把 $y=\\dfrac{3}{4}x+c$ 代入 $x^2+y^2-112x+66y=0$，可得</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$x^2+\\left(\\dfrac{3}{4}x+c\\right)^2-112x+66\\left(\\dfrac{3}{4}x+c\\right)=0$。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">$25x^2+(24c-1\\,000)x+16c^2+1\\,056c=0$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">由於 $L_1$ 及 $L_2$ 均為 $C$ 的切線，可得</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$(24c-1\\,000)^2-4(25)(16c^2+1\\,056c)=0$。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">$16c^2+2\\,400c-15\\,625=0$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$(4c-25)(4c+625)=0$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$c=\\dfrac{25}{4}$  或  $c=\\dfrac{-625}{4}$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">所以，$L_1$ 的方程及 $L_2$ 的方程分別為  $y=\\dfrac{3}{4}x+\\dfrac{25}{4}$  及  $y=\\dfrac{3}{4}x-\\dfrac{625}{4}$ 。</div><div class="ms-mark">1M</div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">留意 $S$ 、 $T$ 、 $U$ 及 $V$ 的坐標分別為 $\\left(\\dfrac{-25}{3},0\\right)$ 、 $\\left(0,\\dfrac{25}{4}\\right)$ 、 $\\left(\\dfrac{625}{3},0\\right)$ 及 $\\left(0,\\dfrac{-625}{4}\\right)$ 。</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">    梯形 $STUV$ 的面積</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$=\\frac{1}{2}\\left(\\frac{625}{3}\\cdot\\frac{625}{4}+\\frac{625}{4}\\cdot\\frac{25}{3}+\\frac{25}{3}\\cdot\\frac{25}{4}+\\frac{25}{4}\\cdot\\frac{625}{3}\\right)$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">$=\\dfrac{105\\,625}{6}$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$\\approx 17\\,604.16667$<br>$&gt;17\\,000$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">因此，該宣稱正確。</div><div class="ms-mark">1A</div></div></div>`
    }
);
