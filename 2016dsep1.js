...
questions.push(
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `令 $x$ 成為公式 $Ax = (4x + B)C$ 的主項。 <span class="marks">(3分)</span>`,
            en: `Make $x$ the subject of the formula $Ax = (4x + B)C$. <span class="marks">(3 marks)</span>`
        },
        hint: {
            tc: `展開後將含 $x$ 的項移到一邊求解。 `,
            en: `Expand the brackets, then move all terms with $x$ to one side to solve.`
        },
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `化簡 $\\dfrac{2}{4x-5} + \\dfrac{3}{1-6x}$。 <span class="marks">(3分)</span>`,
            en: `Simplify $\\dfrac{2}{4x-5} + \\dfrac{3}{1-6x}$. <span class="marks">(3 marks)</span>`
        },
        hint: {
            tc: `通分後合併。 `,
            en: `Find a common denominator, then combine the terms.`
        },
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `因式分解<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">$5m - 10n$，<span class="marks">(1分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">$m^2 + mn - 6n^2$，<span class="marks">(1分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(c)</span><div class="q-text-content">$m^2 + mn - 6n^2 - 5m + 10n$。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
            en: `Factorize<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">$5m - 10n$, <span class="marks">(1 mark)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">$m^2 + mn - 6n^2$, <span class="marks">(1 mark)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(c)</span><div class="q-text-content">$m^2 + mn - 6n^2 - 5m + 10n$. <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 提取公因式。 <br>(b) 十字相乘。 <br>(c) 分組或利用前兩部分。 `,
            en: `(a) Factor out the common factor.<br>(b) Factorize the quadratic expression.<br>(c) Group terms or use the results from (a) and (b).`
        },
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `某遊樂會有 $180$ 名會員且男會員人數較女會員人數多 $40\\%$。 求男會員人數與女會員人數之差。 <span class="marks">(4分)</span>`,
            en: `In a recreation club, there are $180$ members and the number of male members is $40\\%$ more than the number of female members. Find the difference of the number of male members and the number of female members. <span class="marks">(4 marks)</span>`
        },
        hint: {
            tc: `設女會員為 $x$，男會員為 $1.4x$，列出方程求解。 `,
            en: `Let $x$ be the number of female members and $1.4x$ be the number of male members, then set up an equation to solve.`
        },
    ...
    },
    {
        ...
        difficulty: 2,
        content: {
            tc: `考慮複合不等式<div style="text-align: center;">$x+6 < 6(x+11)$  或  $x \\le -5$  ...............(*)</div><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">解 (*)。 <span class="marks">(3分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">寫出滿足 (*) 的最大負整數。 <span class="marks">(1分)</span><div class="q-clearfix"></div></div></div>`,
            en: `Consider the compound inequality<div style="text-align: center;">$x+6 < 6(x+11)$ or $x \\le -5$ ...............(*)</div><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Solve (*). <span class="marks">(3 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">Write down the greatest negative integer satisfying (*). <span class="marks">(1 mark)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 分別解兩個不等式後取聯集。 <br>(b) 從範圍中取最大負整數。 `,
            en: `(a) Solve the two inequalities separately and combine their union.<br>(b) Find the greatest negative integer within the solution range.`
        },
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `<div style="color: red;">在某極坐標系中，$O$ 為極點。 點 $A$ 及點 $B$ 的極坐標分別為 $(12, 75^\\circ)$ 及 $(12, 135^\\circ)$。 <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $\\angle AOB$。 <span class="marks">(1分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">求 $\\Delta AOB$ 的周界。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(c)</span><div class="q-text-content">寫出 $\\Delta AOB$ 的旋轉對稱的折式數目。 <span class="marks">(1分)</span><div class="q-clearfix"></div></div></div></div>`,
            en: `<div style="color: red;">In a polar coordinate system, $O$ is the pole. The polar coordinates of the points $A$ and $B$ are $(12, 75^\\circ)$ and $(12, 135^\\circ)$ respectively. <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find $\\angle AOB$. <span class="marks">(1 mark)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">Find the perimeter of $\\Delta AOB$. <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(c)</span><div class="q-text-content">Write down the number of folds of rotational symmetry of $\\Delta AOB$. <span class="marks">(1 mark)</span><div class="q-clearfix"></div></div></div></div>`
        },
        hint: {
            tc: `(a) 極角差。 <br>(b) 用餘弦公式求 $AB$ 後加兩半徑。 <br>(c) 等腰三角形的旋轉對稱。 `,
            en: `(a) Difference of polar angles.<br>(b) Use cosine formula or isosceles triangle properties to find $AB$, then add $OA$ and $OB$.<br>(c) Rotational symmetry of an equilateral triangle.`
        },
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `已知 $\\mathrm{f}(x)$ 為兩部分之和，一部分隨 $x$ 正變，而另一部分隨 $x^2$ 正變。 假定 $\\mathrm{f}(3)=48$ 及 $\\mathrm{f}(9)=198$。 <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $\\mathrm{f}(x)$。 <span class="marks">(3分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">解方程 $\\mathrm{f}(x)=90$。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
            en: `It is given that $\\mathrm{f}(x)$ is the sum of two parts, one part varies as $x$ and the other part varies as $x^2$. Suppose that $\\mathrm{f}(3)=48$ and $\\mathrm{f}(9)=198$. <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find $\\mathrm{f}(x)$. <span class="marks">(3 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">Solve the equation $\\mathrm{f}(x)=90$. <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 設 $f(x)=Ax + Bx^2$，代入求係數。 <br>(b) 解二次方程。 `,
            en: `(a) Let $\\mathrm{f}(x)=Ax + Bx^2$, substitute given values to solve for constants.<br>(b) Solve the quadratic equation.`
        },
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `下面的頻數分佈表及累積頻數分佈表均顯示某花園內植物的高度的分佈。<div class="q-text-content"><table class="q-table" style="float: left; margin-top: 12px; margin-bottom: 12px; margin-left: 3em; margin-right: auto; border-collapse: collapse; table-layout: auto;">
    <colgroup>
      <col style="width: 8em;">
      <col style="width: 4em;">
    </colgroup>
    ...
    <div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find $x$, $y$ and $z$. <span class="marks">(3 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">If a plant is randomly selected from the garden, find the probability that the height of the selected plant is less than $1.25\\text{ m}$ but not less than $0.65\\text{ m}$. <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 由累積頻數關係求未知數。 <br>(b) 計算對應頻數比例。 `,
            en: `(a) Use the cumulative frequency relation to solve for unknowns.<br>(b) Calculate the probability using corresponding frequencies.`
        },
    ...
    },
    {
        ...
        difficulty: 2,
        content: {
            tc: `點 $A$ 及點 $B$ 的坐標分別為 $(5, 7)$ 及 $(13, 1)$。 設 $P$ 為直角坐標平面上的一動點使得 $P$ 與 $A$ 及 $B$ 等距。 將 $P$ 的軌跡記為 $\\mathit{\\Gamma}$。 <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $\\mathit{\\Gamma}$ 的方程。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">$\\mathit{\\Gamma}$ 與 $x$ 軸及 $y$ 軸分別相交於 $H$ 及 $K$。 將原點記為 $O$。 設 $C$ 為通過 $O$、$H$ 及 $K$ 的圓。 某人宣稱 $C$ 的圓周超過 $30$。 該宣稱是否正確？ 試解釋你的答案。 <span class="marks">(3分)</span><div class="q-clearfix"></div></div></div>`,
            en: `The coordinates of the points $A$ and $B$ are $(5, 7)$ and $(13, 1)$ respectively. Let $P$ be a moving point in the rectangular coordinate plane such that $P$ is equidistant from $A$ and $B$. Denote the locus of $P$ by $\\mathit{\\Gamma}$. <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find the equation of $\\mathit{\\Gamma}$. <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">$\\mathit{\\Gamma}$ intersects the $x$-axis and the $y$-axis at $H$ and $K$ respectively. Denote the origin by $O$. Let $C$ be the circle which passes through $O$, $H$ and $K$. Someone claims that the circumference of $C$ exceeds $30$. Is the claim correct? Explain your answer. <span class="marks">(3 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 垂直平分線方程。 <br>(b) 求截距後求圓半徑比較。 `,
            en: `(a) Equation of perpendicular bisector.<br>(b) Find the intercepts, then compute the radius/diameter of the circle to compare.`
        },
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">設 $(x,y)$ 為 $P$ 的坐標。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$\\sqrt{(x-5)^2+(y-7)^2}=\\sqrt{(x-13)^2+(y-1)^2}$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$4x-3y-24=0$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，$\\mathit{\\Gamma}$ 的方程為 $4x-3y-24=0$。</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-content ms-from-l2"><span style="background-color: #42b4ff;">另解：</span><br>$AB$ 的斜率 $=\\dfrac{7-1}{5-13}=-\\dfrac{3}{4}$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$\\mathit{\\Gamma}$ 的斜率 $=\\dfrac{4}{3}$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$AB$ 的中點 $=\\left(\\dfrac{5+13}{2},\\dfrac{7+1}{2}\\right)=(9,4)$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">所以，$\\mathit{\\Gamma}$ 的方程為 $y-4=\\dfrac{4}{3}(x-9)$。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，$\\mathit{\\Gamma}$ 的方程為 $4x-3y-24=0$。</div><div class="ms-mark">1A</div></div><p><div class="ms-num1">(b)</div><div class="ms-content ms-from-l2">把 $y=0$ 代入 $4x-3y-24=0$，可得 $x=6$。 ......<sup>@</sup></div><div class="ms-mark">1M<sup>@</sup></div></div><div class="ms-row"><div class="ms-content ms-from-l2">故此，$H$ 的坐標為 $(6,0)$。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">把 $x=0$ 代入 $4x-3y-24=0$，可得 $y=-8$。 ......<sup>@</sup></div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">所以，$K$ 的坐標為 $(0,-8)$。</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l2">$C$ 的直徑 $=HK=\\sqrt{(6-0)^2+(0-(-8))^2}=10$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l2">$C$ 的圓周</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=10\\pi$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$\\approx 31.41592654$<br>$&gt;30$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，該宣稱正確。</div><div class="ms-mark">1A</div></div></div>`
    },
    {
        ...
        difficulty: 2,
        content: {
            tc: `某倒置直立圓錐形的容器載有一些牛奶。 將該容器鉛垂放置。 該容器內牛奶的深度為 $12\\text{ cm}$。 <u>文俊</u>隨後將 $444\\pi\\text{ cm}^3$ 的牛奶倒入該容器內，而牛奶沒有溢出。 他現知該容器內牛奶的深度為 $16\\text{ cm}$。 <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">以 $\\pi$ 表該容器內牛奶的最終體積。 <span class="marks">(3分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content"><u>文俊</u>宣稱該容器被浸濕的曲面的最終面積至少為 $800\\text{ cm}^2$。 你是否同意？ 試解釋你的答案。 <span class="marks">(3分)</span><div class="q-clearfix"></div></div></div>`,
            en: `An inverted right circular conical vessel contains some milk. The vessel is held vertically. The depth of milk in the vessel is $12\\text{ cm}$. Peter then pours $444\\pi\\text{ cm}^3$ of milk into the vessel without overflowing. He now finds that the depth of milk in the vessel is $16\\text{ cm}$. <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Express the final volume of milk in the vessel in terms of $\\pi$. <span class="marks">(3 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">Peter claims that the final area of the wet curved surface of the vessel is at least $800\\text{ cm}^2$. Do you agree? Explain your answer. <span class="marks">(3 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 用相似比求最終體積。 <br>(b) 求斜高後計算曲面面積比較。 `,
            en: `(a) Use ratio of volumes of similar figures to find the final volume.<br>(b) Find the slant height, calculate the wet curved surface area and compare.`
        },
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">設 $V\\text{ cm}^3$ 為該容器內牛奶的最終體積。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$\\dfrac{V-444\\pi}{V}=\\left(\\dfrac{12}{16}\\right)^3$</div><div class="ms-mark">1M+1A</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$V=768\\pi$</div><div class="ms-mark">1A</div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，該容器內牛奶的最終體積為 $768\\pi\\text{ cm}^3$。</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l2"><span style="background-color: #42b4ff;">另解：</span><br>設 $V\\text{ cm}^3$ 及 $r\\text{ cm}$ 分別為該容器內牛奶的最終體積及牛奶表面的最終半徑。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$V=\\dfrac{1}{3}\\pi r^2(16)$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$V-444\\pi=\\dfrac{1}{3}\\pi\\left(\\dfrac{12r}{16}\\right)^2(12)$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">故此，可得 $V-444\\pi=\\dfrac{1}{3}\\pi\\left(\\dfrac{12}{16}\\right)^2\\left(\\dfrac{3V}{16\\pi}\\right)(12)$。</div><div class="ms-mark">1M+1A</div></div><div class="ms-row"><div class="ms-content ms-from-l2">求解後，可得 $V=768\\pi$。</div><div class="ms-mark">1A</div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，該容器內牛奶的最終體積為 $768\\pi\\text{ cm}^3$。</div><div class="ms-mark"></div></div><p><div class="ms-num1">(b)</div><div class="ms-content ms-from-l2">設 $r\\text{ cm}$ 為該容器內牛奶表面的最終半徑。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$\\dfrac{1}{3}\\pi r^2(16)=768\\pi$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$r=12$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l2">    該容器被浸濕的曲面的最終面積</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=\\pi(12)\\sqrt{12^2+16^2}$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=240\\pi$<br>$\\approx 753.9822369\\text{ cm}^2$<br>$&lt;800\\text{ cm}^2$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，不同意該宣稱。</div><div class="ms-mark">1A</div></div></div>`
    },
    {
        ...
        hint: {
            ...
            en: `(a) Find $a$ and $b$ using the position of the median.<br>(b) Consider extreme cases of the four new ages for the maximum median and minimum mean.`
        },
    ...
    },
    {
        ...
        difficulty: 2,
        content: {
            tc: `設 $\\mathrm{p}(x) = 6x^4 + 7x^3 + ax^2 + bx + c$，其中 $a$、$b$ 及 $c$ 均為常數。 當 $\\mathrm{p}(x)$ 除以 $x+2$ 時及當 $\\mathrm{p}(x)$ 除以 $x-2$ 時，所得的兩餘數相等。 已知 $\\mathrm{p}(x) \\equiv (lx^2 + 5x + 8)(2x^2 + mx + n)$，其中 $l$、$m$ 及 $n$ 均為常數。 <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $l$、$m$ 及 $n$。 <span class="marks">(5分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">方程 $\\mathrm{p}(x) = 0$ 有多少個實根？ 試解釋你的答案。 <span class="marks">(5分)</span><div class="q-clearfix"></div></div></div>`,
            en: `Let $\\mathrm{p}(x) = 6x^4 + 7x^3 + ax^2 + bx + c$, where $a$, $b$ and $c$ are constants. When $\\mathrm{p}(x)$ is divided by $x+2$ and when $\\mathrm{p}(x)$ is divided by $x-2$, the two remainders are equal. It is given that $\\mathrm{p}(x) \\equiv (lx^2 + 5x + 8)(2x^2 + mx + n)$, where $l$, $m$ and $n$ are constants. <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find $l$, $m$ and $n$. <span class="marks">(5 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">How many real roots does the equation $\\mathrm{p}(x) = 0$ have? Explain your answer. <span class="marks">(5 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 利用餘數相等及比較係數求參數。 <br>(b) 因式分解後判斷實根數目。 `,
            en: `(a) Use the equal remainder property and compare coefficients to find constants.<br>(b) Factorize completely and analyze the number of real roots using the discriminant.`
        },
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">留意  $\\mathrm{p}(2)=152+4a+2b+c$  及  $\\mathrm{p}(-2)=40+4a-2b+c$ 。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">由於 $\\mathrm{p}(2)=\\mathrm{p}(-2)$，可得 $b=-28$。</div><div class="ms-mark">1M</div></div><p><div class="ms-row"><div class="ms-content ms-from-l2">藉比較 $x^4$ 的係數，可得 $l=3$。</div><div class="ms-mark">1A</div></div><div class="ms-row"><div class="ms-content ms-from-l2">留意在 $(3x^2+5x+8)(2x^2+mx+n)$ 的展開式中 $x^3$ 及 $x$ 的係數分別為  $3m+10$  及  $8m+5n$ 。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">故此，可得  $3m+10=7$  及  $8m+5n=-28$ 。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">求解後，可得  $m=-1$  及  $n=-4$ 。</div><div class="ms-mark">1A+1A</div></div><p><div class="ms-num1">(b)</div><div class="ms-content ms-from-l2">$\\mathrm{p}(x)=0$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$(3x^2+5x+8)(2x^2-x-4)=0$ （藉 (a)）</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$3x^2+5x+8=0$  或  $2x^2-x-4=0$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l2">    $5^2-4(3)(8)$ ......<sup>@</sup></div><div class="ms-mark">1M<sup>@</sup></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=-71$ ......<sup>#</sup></div><div class="ms-mark">1A<sup>#</sup></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$&lt;0$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">故此，二次方程 $3x^2+5x+8=0$ 沒有實根。 ......<sup>^</sup></div><div class="ms-mark">1M+1A<sup>^</sup></div></div><p><div class="ms-row"><div class="ms-content ms-from-l2">    $(-1)^2-4(2)(-4)$ ......<sup>@</sup><br>$=33$ ......<sup>#</sup><br>$&gt;0$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">所以，二次方程 $2x^2-x-4=0$ 有 2 個實根。 ......<sup>^</sup></div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l2">由此，方程 $(3x^2+5x+8)(2x^2-x-4)=0$ 有 2 個實根。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，方程 $\\mathrm{p}(x)=0$ 有 2 個實根。</div><div class="ms-mark">1A</div></div></div>`
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `若 $4$ 名男生與 $5$ 名女生隨機排成一隊，求沒有男生在該隊中相鄰而排的概率。 <span class="marks">(3分)</span>`,
            en: `If 4 boys and 5 girls randomly form a queue, find the probability that no boys are next to each other in the queue. <span class="marks">(3 marks)</span>`
        },
        hint: {
            tc: `先排女生再插入男生位置。 `,
            en: `Arrange the girls first, then insert the boys into the available slots between girls.`
        },
    ...
    },
    {
        ...
        difficulty: 2,
        content: {
            tc: `某測驗中，一班學生得分的分佈的平均值為 $61$ 分。 <u>偉健</u>及<u>小麗</u>的標準分分別為 $-2.6$ 及 $1.4$。 <u>偉健</u>得 $22$ 分。 某學生宣稱該分佈的分佈域至多為 $59$ 分。 該宣稱是否正確？ 試解釋你的答案。 <span class="marks">(3分)</span>`,
            en: `In a test, the mean of the distribution of the scores of a class of students is $61$ marks. The standard scores of Albert and Mary are $-2.6$ and $1.4$ respectively. Albert gets $22$ marks. A student claims that the range of the distribution is at most $59$ marks. Is the claim correct? Explain your answer. <span class="marks">(3 marks)</span>`
        },
        hint: {
            tc: `由標準分求標準差，再估計分佈域。 `,
            en: `Find the standard deviation using the standard score formula, then estimate the minimum range to test the claim.`
        },
    ...
    },
    {
        ...
        difficulty: 2,
        content: {
            tc: `某等差數列的第 $1$ 項及第 $38$ 項分別為 $666$ 及 $555$。 求<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">該數列的公差，<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">$n$ 的最大值使得該數列的首 $n$ 項之和為正值。 <span class="marks">(3分)</span><div class="q-clearfix"></div></div></div>`,
            en: `The $1\\text{st}$ term and the $38\\text{th}$ term of an arithmetic sequence are $666$ and $555$ respectively. Find<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">the common difference of the sequence, <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">the greatest value of $n$ such that the sum of the first $n$ terms of the sequence is positive. <span class="marks">(3 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 用通項公式求公差。 <br>(b) 求和公式後解不等式。 `,
            en: `(a) Use the general term formula to find the common difference.<br>(b) Use the sum formula and solve the inequality $S_n > 0$.`
        },
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">設 $d$ 為該數列的公差。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$555=666+(38-1)d$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$d=-3$</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-content ms-from-l2"><span style="background-color: #42b4ff;">另解：</span><br>    該數列的公差</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=\\dfrac{555-666}{38-1}$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=-3$</div><div class="ms-mark">1A</div></div><p><div class="ms-num1">(b)</div><div class="ms-content ms-from-l2">$\\dfrac{n}{2}\\bigl(2(666)+(n-1)(-3)\\bigr)&gt;0$</div><div class="ms-mark">1M+1A</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$1335n-3n^2&gt;0$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$n(n-445)&lt;0$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$0&lt;n&lt;445$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，$n$ 的最大值為 444。</div><div class="ms-mark">1A</div></div></div>`
    },
    {
        ...
        difficulty: 3,
        content: {
            tc: `設 $\\mathrm{f}(x) = -\\dfrac{1}{3}x^2 + 12x - 121$。 <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">利用配方法，求 $y = \\mathrm{f}(x)$ 的圖像的頂點的坐標。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">藉將 $y = \\mathrm{f}(x)$ 的圖像垂直平移得出 $y = \\mathrm{g}(x)$ 的圖像。 若 $y = \\mathrm{g}(x)$ 的圖像與 $x$ 軸相切，求 $\\mathrm{g}(x)$。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(c)</span><div class="q-text-content">在一變換下，$\\mathrm{f}(x)$ 變為 $-\\dfrac{1}{3}x^2 - 12x - 121$。 描述該變換的幾何意義。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
            en: `Let $\\mathrm{f}(x) = -\\dfrac{1}{3}x^2 + 12x - 121$. <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Using the method of completing the square, find the coordinates of the vertex of the graph of $y = \\mathrm{f}(x)$. <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">The graph of $y = \\mathrm{g}(x)$ is obtained by translating the graph of $y = \\mathrm{f}(x)$ vertically. If the graph of $y = \\mathrm{g}(x)$ touches the $x$-axis, find $\\mathrm{g}(x)$. <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(c)</span><div class="q-text-content">Under a transformation, $\\mathrm{f}(x)$ is changed to $-\\dfrac{1}{3}x^2 - 12x - 121$. Describe the geometric meaning of the transformation. <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 配方求頂點。 <br>(b) 垂直平移使判別式為 0。 <br>(c) 對 $y$ 軸反射。 `,
            en: `(a) Complete the square to find the vertex.<br>(b) Translate vertically so that the vertex lies on the $x$-axis.<br>(c) Express as $\\mathrm{f}(-x)$ or $\\mathrm{f}(x+36)$ to deduce the transformation.`
        },
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">    $\\mathrm{f}(x)$<br>$=\\dfrac{-1}{3}x^2+12x-121$<br>$=\\dfrac{-1}{3}(x^2-36x)-121$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=\\dfrac{-1}{3}(x^2-36x+18^2-18^2)-121$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=-\\dfrac{1}{3}(x-18)^2-13$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，頂點的坐標為 $(18,-13)$。</div><div class="ms-mark">1A</div></div><p><div class="ms-num1">(b)</div><div class="ms-content ms-from-l2">    $\\mathrm{g}(x)$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=\\mathrm{f}(x)+13$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=\\dfrac{-1}{3}(x-18)^2$</div><div class="ms-mark">1A</div></div><p><div class="ms-num1">(c)</div><div class="ms-content ms-from-l2">留意 $\\dfrac{-1}{3}x^2-12x-121=\\mathrm{f}(-x)$。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，該變換為對 $y$ 軸的反射。</div><div class="ms-mark">1A+1A</div></div><p><div class="ms-row"><div class="ms-content ms-from-l2"><span style="background-color: #42b4ff;">另解：</span><br>留意 $\\dfrac{-1}{3}x^2-12x-121=\\mathrm{f}(x+36)$。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，該變換為向左平移 36 單位。</div><div class="ms-mark">1A+1A</div></div></div>`
    },
    {
    ...
    },
    {
        ...
        difficulty: 3,
        content: {
            tc: `$\\Delta OPQ$ 為一鈍角三角形。 將 $\\Delta OPQ$ 的內心及外心分別記為 $I$ 及 $J$。 已知 $P$、$I$ 與 $J$ 共線。 <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">證明 $OP = PQ$。 <span class="marks">(3分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">引入一直角坐標系使得 $O$ 及 $Q$ 的坐標分別為 $(0, 0)$ 及 $(40, 30)$，而 $P$ 的 $y$ 坐標為 $19$。 設 $C$ 為通過 $O$、$P$ 及 $Q$ 的圓。</div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">求 $C$ 的方程。 </div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">設 $L_1$ 及 $L_2$ 為 $C$ 的兩切線使得每一切線的斜率均為 $\\dfrac{3}{4}$ 且 $L_1$ 的 $y$ 截距較 $L_2$ 大。 $L_1$ 分別與 $x$ 軸及 $y$ 軸相交於 $S$ 及 $T$，而 $L_2$ 分別與 $x$ 軸及 $y$ 軸相交於 $U$ 及 $V$。 某人宣稱梯形 $STUV$ 的面積超過 $17\\,000$。 該宣稱是否正確？ 試解釋你的答案。 <br><span class="marks">(9分)</span><div class="q-clearfix"></div></div></div>`,
            en: `$\\Delta OPQ$ is an obtuse-angled triangle. Denote the in-centre and the circumcentre of $\\Delta OPQ$ by $I$ and $J$ respectively. It is given that $P$, $I$ and $J$ are collinear. <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Prove that $OP = PQ$. <span class="marks">(3 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">A rectangular coordinate system is introduced so that the coordinates of $O$ and $Q$ are $(0, 0)$ and $(40, 30)$ respectively while the $y$-coordinate of $P$ is $19$. Let $C$ be the circle which passes through $O$, $P$ and $Q$.</div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">Find the equation of $C$.</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">Let $L_1$ and $L_2$ be two tangents to $C$ such that the slope of each tangent is $\\dfrac{3}{4}$ and the $y$-intercept of $L_1$ is greater than that of $L_2$. $L_1$ cuts the $x$-axis and the $y$-axis at $S$ and $T$ respectively while $L_2$ cuts the $x$-axis and the $y$-axis at $U$ and $V$ respectively. Someone claims that the area of the trapezium $STUV$ exceeds $17\\,000$. Is the claim correct? Explain your answer. <br><span class="marks">(9 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 利用內心外心性質。 <br>(b) 求圓方程後求切線及梯形面積。 `,
            en: `(a) Use properties of in-centre and circumcentre.<br>(b) Find the equation of circle $C$, then determine tangents $L_1, L_2$, their intercepts, and calculate the area of trapezium $STUV$.`
        },
        solution: `<div class="ms-container"><div class="ms-row" style="white-space: pre; overflow-x: visible; overflow-y: visible;"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2" style="white-space: pre; overflow-x: visible; overflow-y: visible; grid-column: 2 / 6;">留意 $J$ 為圓 $OPQ$ 的圓心。<br>$\\angle IPO=\\angle JPQ$\t\t\t[$\\Delta$內心]<br>再者留意 $P$、$I$ 與 $J$ 共線。<br>$\\angle JPO=\\angle JPQ$<br>$JO=JP$\t\t\t\t\t[半徑]<br>$\\angle JOP=\\angle JPO$\t\t\t[等腰 $\\Delta$ 底角]<br>$JP=JQ$\t\t\t\t\t[半徑]<br>$\\angle JPQ=\\angle JQP$\t\t\t[等腰 $\\Delta$ 底角]<br>$\\angle JOP=\\angle JQP$<br>$JP=JP$\t\t\t\t\t[公共邊]<br>$\\Delta JOP\\cong\\Delta JQP$\t\t\t(AAS)<br>因此，可得 $OP=PQ$。\t[全等 $\\Delta$ 的對應邊]</div><div class="ms-mark"></div></div><p><div class="ms-row" style="white-space: pre; overflow-x: visible; overflow-y: visible;"><div class="ms-content ms-from-l2" style="white-space: pre; overflow-x: visible; overflow-y: visible; grid-column: 2 / 6;"><span style="background-color: #42b4ff;">另解 1：</span><br>留意 $J$ 為圓 $OPQ$ 的圓心。<br>$\\angle IPO = \\angle IPQ$\t\t\t\t[$\\Delta$內心]<br>再者留意 $P$、$I$ 與 $J$ 共線。<br>$\\angle JPO = \\angle JPQ$<br>$JP = JQ$\t\t\t\t\t\t[半徑]<br>$\\angle JQP = \\angle JPQ$\t\t\t\t[等腰 $\\Delta$ 底角]<br>            $= \\angle JPO$<br>$2\\angle POQ = \\angle PJQ$\t\t\t\t[圓心角兩倍於圓周角]<br>              $= 180^\\circ - \\angle JPQ - \\angle JQP$\t[$\\Delta$內角和]<br>              $= 180^\\circ - \\angle JPQ - \\angle JPO$<br>              $= \\angle POQ + \\angle OQP$\t\t[$\\Delta$內角和]<br>$\\angle POQ = \\angle OQP$<br>因此，可得 $OP = PQ$ 。\t\t[等角對邊相等]</div></div><p><div class="ms-row" style="white-space: pre; overflow-x: visible; overflow-y: visible;"><div class="ms-content ms-from-l2" style="white-space: pre; overflow-x: visible; overflow-y: visible; grid-column: 2 / 6;"><span style="background-color: #42b4ff;">另解 2：</span><br>留意 $J$ 為圓 $OPQ$ 的圓心。<br>$\\angle IPO = \\angle IPQ$\t\t\t[$\\Delta$內心]<br>再者留意 $P$、$I$ 與 $J$ 共線。<br>$\\angle JPO = \\angle JPQ$<br>$JO = JP$\t\t\t\t\t[半徑]<br>$\\angle JOP = \\angle JPO$\t\t\t[等腰 $\\Delta$ 底角]<br>$JP = JQ$\t\t\t\t\t[半徑]<br>$\\angle JPQ = \\angle JQP$\t\t\t[等腰 $\\Delta$ 底角]<br>$\\angle JOP = \\angle JQP$<br>$JO = JQ$\t\t\t\t\t[半徑]<br>$\\angle JOQ = \\angle JQO$\t\t\t[等腰 $\\Delta$ 底角]<br>$\\angle JOP - \\angle JOQ = \\angle JQP - \\angle JQO$<br>$\\angle POQ = \\angle OQP$<br>因此，可得 $OP = PQ$ 。\t[等角對邊相等]</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l2" style="border:1px solid #555555; padding:2px 4px; border-right: none; white-space: pre; overflow-x: auto;">評分標準：<br>情況 1\t附有正確理由的任何正確證明。<br>情況 2\t未附有理由的任何正確證明。<br>情況 3\t附有一正確理由和一正確步驟之未完整的證明。</div><div class="ms-mark" style="border:1px solid #555555; padding:2px 4px; border-left: none;"><br>3<br>2<br>1</div></div><p><div class="ms-num1">(b)</div><div class="ms-num2">(i)</div><div class="ms-content ms-from-l3">設 $(h,19)$ 為 $P$ 的坐標。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">藉 (a)，可得 $h^2+19^2=(40-h)^2+(30-19)^2$。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">求解後，可得 $h=17$。</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">設 $x^2+y^2+Dx+Ey+F=0$ 為 $C$ 的方程。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">由於 $C$ 通過原點，可得 $F=0$。</div><div class="ms-mark">1A</div></div><div class="ms-row"><div class="ms-content ms-from-l3">故此，可得  $17D+19E+650=0$  及  $40D+30E+2\\,500=0$ 。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">求解後，可得  $D=-112$  及  $E=66$ 。</div><div class="ms-mark">1A</div></div><div class="ms-row"><div class="ms-content ms-from-l3">因此，$C$ 的方程為 $x^2+y^2-112x+66y=0$。</div><div class="ms-mark"></div></div><p><div class="ms-num2">(ii)</div><div class="ms-content ms-from-l3">留意 $L_1$ 的方程及 $L_2$ 的方程均為 $y=\\dfrac{3}{4}x+c$ 的形式，其中 $c$ 為一常數。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">把 $y=\\dfrac{3}{4}x+c$ 代入 $x^2+y^2-112x+66y=0$，可得</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$x^2+\\left(\\dfrac{3}{4}x+c\\right)^2-112x+66\\left(\\dfrac{3}{4}x+c\\right)=0$。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">$25x^2+(24c-1\\,000)x+16c^2+1\\,056c=0$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">由於 $L_1$ 及 $L_2$ 均為 $C$ 的切線，可得</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$(24c-1\\,000)^2-4(25)(16c^2+1\\,056c)=0$。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">$16c^2+2\\,400c-15\\,625=0$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$(4c-25)(4c+625)=0$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$c=\\dfrac{25}{4}$  或  $c=\\dfrac{-625}{4}$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">所以，$L_1$ 的方程及 $L_2$ 的方程分別為  $y=\\dfrac{3}{4}x+\\dfrac{25}{4}$  及  $y=\\dfrac{3}{4}x-\\dfrac{625}{4}$ 。</div><div class="ms-mark">1M</div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">留意 $S$ 、 $T$ 、 $U$ 及 $V$ 的坐標分別為 $\\left(\\dfrac{-25}{3},0\\right)$ 、 $\\left(0,\\dfrac{25}{4}\\right)$ 、 $\\left(\\dfrac{625}{3},0\\right)$ 及 $\\left(0,\\dfrac{-625}{4}\\right)$ 。</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">    梯形 $STUV$ 的面積</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$=\\frac{1}{2}\\left(\\frac{625}{3}\\cdot\\frac{625}{4}+\\frac{625}{4}\\cdot\\frac{25}{3}+\\frac{25}{3}\\cdot\\frac{25}{4}+\\frac{25}{4}\\cdot\\frac{625}{3}\\right)$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">$=\\dfrac{105\\,625}{6}$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$\\approx 17\\,604.16667$<br>$&gt;17\\,000$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">因此，該宣稱正確。</div><div class="ms-mark">1A</div></div></div>`
    }
);
