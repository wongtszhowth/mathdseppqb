...
questions.push(
    ...
    },
    {
        ...
        difficulty: 2,
        content: `下面的圓形圖顯示某校學生出生季節的分佈。<br>（圖中標示：秋季、夏季 $158^\\circ$、冬季、$x$ 為春季）<br>若從該校中隨機選出一名學生，則所選出的學生在春季出生的概率為 $\\dfrac{1}{9}$。<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $x$。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">該校有 $180$ 名學生在冬季出生。求該校學生的人數。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
    ...
    },
    {
        ...
        difficulty: 2,
        content: `若一個瓶子的容量量得 $200$ mL 準確至最接近的 $10$ mL，則稱它為標準。<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求一個標準瓶子的最小可取容量。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">某人宣稱 $120$ 個標準瓶子的總容量可量得 $23.3$ L 準確至最接近的 $0.1$ L。你是否同意？試解釋你的答案。<span class="marks">(3分)</span><div class="q-clearfix"></div></div></div>`,
    ...
    },
    {
        ...
        difficulty: 2,
        content: `圖1中，$OPQR$ 為四邊形使得 $OP = OQ = OR$。$OQ$ 與 $PR$ 相交於點 $S$。$S$ 為 $PR$ 的中點。<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">證明 $\\triangle OPS \\cong \\triangle ORS$。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">已知 $O$ 為通過 $P$、$Q$ 及 $R$ 的圓的圓心。若 $OQ = 6$ cm 及 $\\angle PRQ = 10^\\circ$，求扇形 $OPQR$ 的面積，答案以 $\\pi$ 表示。<span class="marks">(4分)</span><div class="q-clearfix"></div></div></div>`,
    ...
    },
    {
        ...
        difficulty: 3,
        content: `下面的幹葉圖顯示一群工人的時薪（以元為單位）的分佈。<br><table class="q-table"><tr><th>幹（十位）</th><th>葉（個位）</th></tr><tr><td>6</td><td>1 1 1 3 4 6 8 9 9</td></tr><tr><td>7</td><td>$a$ 7 7 8</td></tr><tr><td>8</td><td>1 $b$</td></tr></table><br>已知上述分佈的平均值及分佈域分別為 $70$ 及 $22$。<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求上述分佈的中位數及標準差。<span class="marks">(5分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">若從該群中隨機選出一名工人，求所選出的工人的時薪超過 $70$ 的概率。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
    ...
    },
    {
        ...
        topic: ["Mensuration"],
        difficulty: 3,
        content: `把一底面積為 $84$ cm$^2$ 及高為 $20$ cm 的實心金屬直立角柱體熔化，並重鑄成兩個相似的實心直立角錐體。該兩個角錐體的底均為正方形。較小的角錐體的底面積與較大的角錐體的底面積之比為 $4:9$。<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求較大的角錐體的體積。<span class="marks">(3分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">若較大的角錐體的高為 $12$ cm，求較小的角錐體的總表面面積。<span class="marks">(4分)</span><div class="q-clearfix"></div></div></div>`,
    ...
    },
    {
        ...
        difficulty: 3,
        content: `點 $E$、點 $F$ 及點 $G$ 的坐標分別為 $(-6,5)$、$(-3,11)$ 及 $(2,-1)$。圓 $C$ 通過 $E$ 且 $C$ 的圓心為 $G$。<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $C$ 的方程。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">證明 $F$ 在 $C$ 以外。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(c)</span><div class="q-text-content">設 $H$ 為 $C$ 上的一動點。當 $H$ 最遠離 $F$ 時，<br><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">描述 $F$、$G$ 與 $H$ 之間的幾何關係；</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">求通過 $F$ 及 $H$ 的直線的方程。<br><span class="marks">(3分)</span><div class="q-clearfix"></div></div></div></div></div>`,
    ...
    },
    {
        ...
        difficulty: 3,
        content: `設 $f(x) = 6x^3 - 13x^2 - 46x + 34$。當 $f(x)$ 除以 $2x^2 + ax + 4$ 時，商式及餘式分別為 $3x + 7$ 及 $bx + c$，其中 $a$、$b$ 及 $c$ 均為常數。<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $a$。<span class="marks">(3分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">設 $g(x)$ 為二次多項式使得當 $g(x)$ 除以 $2x^2 + ax + 4$ 時，餘式為 $bx + c$。<br><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">證明 $f(x) - g(x)$ 可被 $2x^2 + ax + 4$ 整除。</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">某人宣稱方程 $f(x) - g(x) = 0$ 所有的根均為整數。你是否同意？試解釋你的答案。<br><span class="marks">(5分)</span><div class="q-clearfix"></div></div></div></div></div>`,
    ...
    },
    {
        ...
        difficulty: 3,
        content: `拋物線 $\\Gamma$ 的方程為 $y = 2x^2 - 2kx + 2x - 3k + 8$，其中 $k$ 為一實常數。將直線 $y = 19$ 記為 $L$。<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">證明 $L$ 與 $\\Gamma$ 相交於兩相異點。<span class="marks">(3分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">$L$ 與 $\\Gamma$ 的交點為 $A$ 及 $B$。<br><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">設 $a$ 及 $b$ 分別為 $A$ 及 $B$ 的 $x$ 坐標。證明 $(a-b)^2 = k^2 + 4k + 23$。</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">$A$ 與 $B$ 間的距離有沒有可能少於 $4$？試解釋你的答案。<br><span class="marks">(5分)</span><div class="q-clearfix"></div></div></div></div></div>`,
    ...
    },
    {
        ...
        difficulty: 3,
        content: `$ABC$ 為三角形金屬薄片，其中 $BC = 24$ cm、$\\angle BAC = 30^\\circ$ 及 $\\angle ACB = 42^\\circ$。<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $AC$ 的長度。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">圖 2 中，把金屬薄片 $ABC$ 懸掛使得只有頂點 $B$ 位於水平地面上。$D$ 及 $E$ 均為水平地面上的點，且分別鉛垂於頂點 $A$ 及頂點 $C$ 之下。$AC$ 的延線與水平地面相交於點 $F$。某工匠得知 $AD = 10$ cm 及 $CE = 2$ cm。<br><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">求 $C$ 與 $F$ 間的距離。</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">求 $\\triangle ABF$ 的面積。</div></div><div class="q-line q-level-2"><span class="q-label">(iii)</span><div class="q-text-content">求金屬薄片 $ABC$ 與水平地面間的傾角。</div></div><div class="q-line q-level-2"><span class="q-label">(iv)</span><div class="q-text-content">該工匠宣稱 $\\triangle BDF$ 的面積大於 $460$ cm$^2$。你是否同意？試解釋你的答案。<br><span class="marks">(11分)</span><div class="q-clearfix"></div></div></div></div></div>`,
