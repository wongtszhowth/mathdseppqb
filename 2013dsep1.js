...
questions.push(
    {
        ...
        difficulty: 1,
        content: {
            tc: `化簡 $\\dfrac{x^{20}y^{13}}{(x^5y)^6}$，並以正指數表示答案。<span class="marks">(3分)</span>`,
            en: `Simplify $\\dfrac{x^{20}y^{13}}{(x^5y)^6}$ and express your answer with positive indices.<span class="marks">(3 marks)</span>`
        },
        hint: {
            tc: `先展開分母指數，再應用指數定律。`,
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `令 $k$ 成為公式 $\\dfrac{3}{h} - \\dfrac{1}{k} = 2$ 的主項。 <span class="marks">(3分)</span>`,
            en: `Make $k$ the subject of the formula $\\dfrac{3}{h} - \\dfrac{1}{k} = 2$. <span class="marks">(3 marks)</span>`
        },
        hint: {
            tc: `通分後解出 $k$。 `,
            en: `Find a common denominator and solve for $k$.`
        },
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `因式分解<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">$4m^2 - 25n^2$，<span class="marks">(1分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">$4m^2 - 25n^2 + 6m - 15n$。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
            en: `Factorize<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">$4m^2 - 25n^2$,<span class="marks">(1 mark)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">$4m^2 - 25n^2 + 6m - 15n$. <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 平方差。 <br>(b) 分組因式分解。 `,
            en: `(a) Difference of two squares. <br>(b) Factorization by grouping.`
        },
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `$7$ 個梨和 $3$ 個橙的價錢為 $\\$47$，而 $5$ 個梨和 $6$ 個橙的價錢為 $\\$49$。 求一個梨的價錢。 <span class="marks">(4分)</span>`,
            en: `The price of $7$ pears and $3$ oranges is $\\$47$ while the price of $5$ pears and $6$ oranges is $\\$49$. Find the price of a pear. <span class="marks">(4 marks)</span>`
        },
        hint: {
            tc: `設梨價為 $x$，橙價為 $y$，解聯立方程。 `,
            en: `Let $x$ be the price of a pear and $y$ be the price of an orange, then solve simultaneous equations.`
        },
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">解不等式 $\\dfrac{19-7x}{3} > 23-5x$。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">求所有能同時滿足不等式 $\\dfrac{19-7x}{3} > 23-5x$ 及不等式 $18-2x \\ge 0$ 的整數。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
            en: `<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Solve the inequality $\\dfrac{19-7x}{3} > 23-5x$. <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">Find all integers satisfying both the inequalities $\\dfrac{19-7x}{3} > 23-5x$ and $18-2x \\ge 0$. <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 解不等式。 <br>(b) 取交集後列出整數。 `,
            en: `(a) Solve the inequality. <br>(b) Find the intersection and list all integers.`
        },
    ...
    },
    {
        ...
        difficulty: 2,
        content: {
            tc: `<div style="color: red;">在某極坐標系中，$O$ 為極點，點 $A$ 及點 $B$ 的極坐標分別為 $(26,10^\\circ)$ 及 $(26,130^\\circ)$。 設 $L$ 為 $\\Delta OAB$ 的反射對稱軸。 <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">描述 $L$ 與 $\\angle AOB$ 之間的幾何關係。 <span class="marks">(1分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">求 $L$ 與 $AB$ 的交點的極坐標。 <span class="marks">(3分)</span><div class="q-clearfix"></div></div></div></div>`,
            en: `<div style="color: red;">In a polar coordinate system, $O$ is the pole. The polar coordinates of the points $A$ and $B$ are $(26,10^\circ)$ and $(26,130^\circ)$ respectively. Let $L$ be the axis of reflectional symmetry of $\\Delta OAB$. <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Describe the geometric relationship between $L$ and $\\angle AOB$. <span class="marks">(1 mark)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">Find the polar coordinates of the point of intersection of $L$ and $AB$. <span class="marks">(3 marks)</span><div class="q-clearfix"></div></div></div></div>`
        },
        hint: {
            tc: `(a) 角平分線。 <br>(b) 求交點極坐標。 `,
            en: `(a) Angle bisector. <br>(b) Find the polar coordinates of the point of intersection.`
        },
    ...
    },
    {
        ...
        content: {
            ...
            en: `In the figure, $ABCD$ is a quadrilateral. The diagonals $AC$ and $BD$ intersect at $E$. It is given that $BE = CE$ and $\\angle BAC = \\angle BDC$. <img src="img/2013dsep1q07.jpg" class="q-img" alt="題目附圖" style="max-width: 50%;"><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Prove that $\\Delta ABC \\cong \\Delta DCB$. <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">Consider the triangles in the figure.</div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">How many pairs of congruent triangles are there?</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">How many pairs of similar triangles are there?<br><span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 利用 SAS 或 ASA 證明。 <br>(b) 數算全等及相似對數。 `,
            en: `(a) Prove using AAS or ASA. <br>(b) Count the number of pairs of congruent and similar triangles.`
        },
        solution: `<div class="ms-container"><div class="ms-row" style="white-space: pre; overflow-x: visible; overflow-y: visible;"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2" style="white-space: pre; overflow-x: visible; overflow-y: visible; grid-column: 2 / 6;">在 $\\Delta ABC$ 及 $\\Delta DCB$ 中，<br>$\\angle BCE=\\angle CBE$\t[等腰 $\\Delta$ 底角]<br>$\\angle BAC=\\angle BDC$\t[已知]<br>$BC=BC$\t\t\t[公共邊]<br>$\\Delta ABC\\cong\\Delta DCB$\t(AAS)</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2" style="border:1px solid #555555; padding:2px 4px; border-right: none; white-space: pre; overflow-x: auto;">評分標準：<br>情況 1\t附有正確理由的任何正確證明。<br>情況 2\t未附有正確理由的任何正確證明。</div><div class="ms-mark" style="border:1px solid #555555; padding:2px 4px; border-left: none;"><br>2<br>1</div></div><p><div class="ms-row"><div class="ms-num1">(b)</div><div class="ms-num2">(i)</div><div class="ms-content ms-from-l3">有 3 對全等三角形。</div><div class="ms-mark">1A</div></div><div class="ms-row"><div class="ms-num2">(ii)</div><div class="ms-content ms-from-l3">有 4 對相似三角形。</div><div class="ms-mark">1A</div></div></div>`
    },
    {
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `下面的棒形圖顯示 $D$ 公司僱員的家庭成員人數的分佈。<img src="img/2013dsep1q09zh.jpg" class="q-img" alt="題目附圖" style="max-width: 80%;"><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求上述分佈的平均值、四分位數間距及標準差。<span class="marks">(4分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">$D$ 公司某僱員離職。 這僱員的家庭成員人數為 $7$。 求這僱員離職而引致 $D$ 公司僱員的家庭成員人數的標準差的改變。<span class="marks">(1分)</span><div class="q-clearfix"></div></div></div>`,
            en: `The bar chart below shows the distribution of the numbers of family members of the employees of company $D$.<img src="img/2013dsep1q09en.jpg" class="q-img" alt="題目附圖" style="max-width: 80%;"><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find the mean, the inter-quartile range and the standard deviation of the above distribution.<span class="marks">(4 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">An employee leaves company $D$. The number of family members of this employee is $7$. Find the change in the standard deviation of the numbers of family members of the employees of company $D$ due to the leaving of this employee.<span class="marks">(1 mark)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 從圖讀取頻數後計算。 <br>(b) 重新計算標準差比較。 `,
            en: `(a) Read the frequencies from the chart and calculate. <br>(b) Recalculate the standard deviation and find the difference.`
        },
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `$A$ 委員會的委員年歲如下：<div style="text-align: center; white-space: pre;">$17$　$18$　$21$　$21$　$22$　$22$　$23$　$23$　$23$　$31$<br>$31$　$34$　$35$　$36$　$47$　$47$　$58$　$68$　$69$　$69$</div><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">寫出 $A$ 委員會的委員年歲的中位數及眾數。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">下面的幹葉圖顯示 $B$ 委員會的委員年歲的分佈。 已知這分佈的分佈域為 $47$。
    ...
    <tr>
      ...
      <td style="border-left: 1px solid black; text-align: left; padding: 0px 10px;">7　$b$</td>
            ...
            en: `The ages of the members of Committee $A$ are shown as follows:<div style="text-align: center; white-space: pre;">$17$　$18$　$21$　$21$　$22$　$22$　$23$　$23$　$23$　$31$<br>$31$　$34$　$35$　$36$　$47$　$47$　$58$　$68$　$69$　$69$</div><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Write down the median and the mode of the ages of the members of Committee $A$. <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">The stem-and-leaf diagram below shows the distribution of the ages of the members of Committee $B$. It is given that the range of this distribution is $47$.
		<table class="q-table" style="border-collapse: collapse; table-layout: auto; width: auto; white-space: pre;" align="center">
    <colgroup>
      <col style="width: auto;">
      <col style="width: auto;">
  ...
  </table></div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">Find $a$ and $b$. </div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">From each committee, a member is randomly selected as the representative of that committee. The two representatives can join a competition when the difference of their ages exceeds $40$. Find the probability that these two representatives can join the competition. <br><span class="marks">(4 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 排序後求中位數及眾數。 <br>(b) 由分佈域求 $a$、$b$，再計算概率。 `,
            en: `(a) Find the median and mode from the ordered data. <br>(b) Find $a$ and $b$ using the range, then calculate the probability.`
        },
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">中位數 $=31$</div><div class="ms-mark">1A</div></div><div class="ms-row"><div class="ms-content ms-from-l2">眾數 $=23$</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num1">(b)</div><div class="ms-num2">(i)</div><div class="ms-content ms-from-l3">留意  $0\\le a\\le 5$  及  $7\\le b\\le 9$ 。<br>再者留意該分佈的分布域為 47。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">因此，可得  $\\begin{cases}a=0\\\\b=7\\end{cases}$ 、 $\\begin{cases}a=1\\\\b=8\\end{cases}$  或  $\\begin{cases}a=2\\\\b=9\\end{cases}$ 。</div><div class="ms-mark">1A+1A</div></div><p><div class="ms-row"><div class="ms-num2">(ii)</div><div class="ms-content ms-from-l3">    所求的概率</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$=\\dfrac{3+3+3+3+2+9+9}{260}$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">$=\\dfrac{32}{260}$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$=\\dfrac{8}{65}$</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-content ms-from-l3"><span style="background-color: #42b4ff;">另解：</span><br>    所求的概率</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$=\\dfrac{3+3+2+2+2+2+2+2+2+4+4+4}{260}$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">$=\\dfrac{32}{260}$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$=\\dfrac{8}{65}$</div><div class="ms-mark">1A</div></div></div>`
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `一周界為 $\\ell$ 米的托盤的重量為 $W$ 克。 已知 $W$ 為兩部分之和，一部分隨 $\\ell$ 正變，另一部分隨 $\\ell^2$ 正變。 當 $\\ell=1$ 時，$W=181$； 且當 $\\ell=2$ 時，$W=402$。 <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求一周界為 $1.2$ 米的托盤的重量。 <span class="marks">(4分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">若一托盤的重量為 $594$ 克，求該托盤的周界。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
            en: `The weight of a tray of perimeter $\\ell$ metres is $W$ grams. It is given that $W$ is the sum of two parts, one part varies directly as $\\ell$ and the other part varies directly as $\\ell^2$. When $\\ell=1$, $W=181$ and when $\\ell=2$, $W=402$. <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find the weight of a tray of perimeter $1.2$ metres. <span class="marks">(4 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">If the weight of a tray is $594$ grams, find the perimeter of the tray. <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 設 $W = A\\ell + B\\ell^2$，代入求係數。 <br>(b) 解二次方程。 `,
            en: `(a) Let $W = A\\ell + B\\ell^2$, substitute values to find the constants. <br>(b) Solve the quadratic equation.`
        },
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `設 $\\mathrm{f}(x) = 3x^3 - 7x^2 + kx - 8$，其中 $k$ 為一常數。 已知 $\\mathrm{f}(x) \\equiv (x-2)(ax^2 + bx + c)$，其中 $a$、$b$ 及 $c$ 均為常數。 <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $a$、$b$ 及 $c$。 <span class="marks">(4分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">某人宣稱方程 $\\mathrm{f}(x) = 0$ 所有的根均為實數。 你是否同意？ 試解釋你的答案。 <span class="marks">(3分)</span><div class="q-clearfix"></div></div></div>`,
            en: `Let $\\mathrm{f}(x) = 3x^3 - 7x^2 + kx - 8$, where $k$ is a constant. It is given that $\\mathrm{f}(x) \\equiv (x-2)(ax^2 + bx + c)$, where $a$, $b$ and $c$ are constants. <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find $a$, $b$ and $c$. <span class="marks">(4 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">Someone claims that all the roots of the equation $\\mathrm{f}(x) = 0$ are real numbers. Do you agree? Explain your answer. <span class="marks">(3 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 比較係數求 $a$、$b$、$c$ 及 $k$。 <br>(b) 因式分解後檢查判別式。 `,
            en: `(a) Compare coefficients to find $a$, $b$, $c$ and $k$. <br>(b) Check the discriminant after factorizing.`
        },
    ...
    },
    {
        ...
        difficulty: 2,
        content: {
            tc: `在某工場內，把 $2$ 個底半徑均為 $R\\text{ cm}$ 的完全相同的實心金屬直立圓柱體熔化，並重鑄成 $27$ 個底半徑均為 $r\\text{ cm}$ 及高均為 $10\\text{ cm}$ 的完全相同的較小的實心直立圓柱體。 已知較大的圓柱體的底面積為較小的 $9$ 倍。 <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求</div></div><div class="q-level-2"><span class="q-label">(i)</span><div class="q-text-content">$r : R$，</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">較大的圓柱體的高。<br><span class="marks">(5分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">某工匠宣稱較小的圓柱體與較大的圓柱體相似。 你是否同意？ 試解釋你的答案。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
            en: `In a workshop, $2$ identical solid metal right circular cylinders of base radius $R\\text{ cm}$ are melted and recast into $27$ smaller identical solid right circular cylinders of base radius $r\\text{ cm}$ and height $10\\text{ cm}$. It is given that the base area of a larger circular cylinder is $9$ times that of a smaller one. <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find</div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">$r : R$,</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">the height of a larger circular cylinder.<br><span class="marks">(5 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">A craftsman claims that a smaller circular cylinder and a larger circular cylinder are similar. Do you agree? Explain your answer.<span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 用底面積比及體積守恆求高。 <br>(b) 比較高與半徑比。 `,
            en: `(a) Use base area ratio and conservation of volume to find the height. <br>(b) Compare the ratio of height to radius.`
        },
...
<p><div class="ms-row"><div class="ms-content ms-from-l2"><span style="background-color: #42b4ff;">另解 2：</span><br>$\\dfrac{\\text{較小的圓柱體的底半徑}}{\\text{較大的圓柱體的底半徑}}=\\dfrac{1}{3}$<br>$\\left(\\dfrac{\\text{較小的圓柱體的底半徑}}{\\text{較大的圓柱體的底半徑}}\\right)^3=\\left(\\dfrac{1}{3}\\right)^3=\\dfrac{1}{27}$<br>$\\dfrac{\\text{較小的圓柱體的體積}}{\\text{較大的圓柱體的體積}}=\\dfrac{2}{27}$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$\\dfrac{\\text{較小的圓柱體的體積}}{\\text{較大的圓柱體的體積}}\\neq\\left(\\dfrac{\\text{較小的圓柱體的底半徑}}{\\text{較大的圓柱體的底半徑}}\\right)^3$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">所以，該兩圓柱體不相似。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，不同意該宣稱。</div><div class="ms-mark">1A</div></div></div>`
    },
    {
        ...
        difficulty: 2,
        content: {
            tc: `圓 $C$ 的方程為 $x^2 + y^2 - 12x - 34y + 225 = 0$。 將 $C$ 的圓心記為 $R$。 <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">寫出 $R$ 的坐標。 <span class="marks">(1分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">直線 $L$ 的方程為 $4x + 3y + 50 = 0$。 現知 $C$ 與 $L$ 沒有相交。 設 $P$ 為 $L$ 上的一點使得 $P$ 最接近 $R$。</div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">求 $P$ 與 $R$ 間的距離。 </div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">設 $Q$ 為 $C$ 上的一動點。 當 $Q$ 最接近 $P$ 時，</div></div><div class="q-line q-level-3"><span class="q-label">(1)</span><div class="q-text-content">描述 $P$、$Q$ 與 $R$ 之間的幾何關係；</div></div><div class="q-line q-level-3"><span class="q-label">(2)</span><div class="q-text-content">求 $\\Delta OPQ$ 的面積與 $\\Delta OQR$ 的面積之比，其中 $O$ 為原點。<br><span class="marks">(8分)</span><div class="q-clearfix"></div></div></div>`,
            en: `The equation of the circle $C$ is $x^2 + y^2 - 12x - 34y + 225 = 0$. Denote the centre of $C$ by $R$. <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Write down the coordinates of $R$. <span class="marks">(1 mark)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">The equation of the straight line $L$ is $4x + 3y + 50 = 0$. It is found that $C$ and $L$ do not intersect. Let $P$ be a point lying on $L$ such that $P$ is nearest to $R$.</div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">Find the distance between $P$ and $R$. </div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">Let $Q$ be a moving point on $C$. When $Q$ is nearest to $P$,</div></div><div class="q-line q-level-3"><span class="q-label">(1)</span><div class="q-text-content">describe the geometric relationship between $P$, $Q$ and $R$;</div></div><div class="q-line q-level-3"><span class="q-label">(2)</span><div class="q-text-content">find the ratio of the area of $\\Delta OPQ$ to the area of $\\Delta OQR$, where $O$ is the origin.<br><span class="marks">(8 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 完成平方求圓心。 <br>(b) 點到直線距離；分析最短距離幾何關係。 `,
            en: `(a) Complete the square to find the centre. <br>(b) Perpendicular distance from point to line; analyze geometric relationship for shortest distance.`
        },
    ...
    },
    {
        ...
        difficulty: 2,
        content: {
            tc: `下面的框線圖顯示某班學生在一測驗中得分（以分為單位）的分佈。 在該測驗中，<u>素珊</u>獲最高得分，而<u>志誠</u>獲得 $65$ 分。 <u>素珊</u>及<u>志誠</u>在該測驗中的標準分分別為 $3$ 及 $0.5$。<img src="img/2013dsep1q15zh.jpg" class="q-img" alt="題目附圖" style="max-width: 80%;"><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求該分佈的平均值。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content"><u>素珊</u>宣稱在該測驗中至少一半學生的標準分均為負值。 你是否同意？ 試解釋你的答案。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
            en: `The box-and-whisker diagram below shows the distribution of the scores (in marks) of the students of a class in a test. Susan gets the highest score while Tom gets $65$ marks in the test. The standard scores of Susan and Tom in the test are $3$ and $0.5$ respectively.<img src="img/2013dsep1q15en.jpg" class="q-img" alt="題目附圖" style="max-width: 80%;"><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find the mean of the distribution. <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">Susan claims that the standard scores of at least half of the students in the test are negative. Do you agree? Explain your answer. <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 用標準分反求平均值。 <br>(b) 比較中位數與平均值。 `,
            en: `(a) Use the standard score formula to solve for the mean. <br>(b) Compare the median and the mean.`
        },
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `某盒子內有 $5$ 個白色杯及 $11$ 個藍色杯。 若從該盒子中隨機同時抽出 $6$ 個杯，<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求抽出至少 $4$ 個白色杯的概率；<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">求抽出至少 $3$ 個藍色杯的概率。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
            en: `A box contains $5$ white cups and $11$ blue cups. If $6$ cups are randomly drawn from the box at the same time, <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">find the probability that at least $4$ white cups are drawn; <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">find the probability that at least $3$ blue cups are drawn. <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `用組合數計算。 `,
    ...
    },
    {
        ...
        difficulty: 2,
        content: {
            tc: `<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">設 $\\mathrm{f}(x) = 36x - x^2$。 利用配方法，求 $y = \\mathrm{f}(x)$ 的圖像的頂點的坐標。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">一條繩子的長度為 $108\\text{ m}$。 某保安員將該繩子分割為兩條。 一條用作圍成一面積為 $A\\text{ m}^2$ 的長方形禁區；另一條長度為 $x\\text{ m}$，且用作將這禁區分成兩長方形區域，如圖所示。<img src="img/2013dsep1q17b.jpg" class="q-img" alt="題目附圖" style="max-width: 60%;"></div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">以 $x$ 表 $A$。 </div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">該保安員宣稱這禁區的面積可大於 $500\\text{ m}^2$。 你是否同意？ 試解釋你的答案。 <br><span class="marks">(4分)</span><div class="q-clearfix"></div></div></div>`,
            en: `<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Let $\\mathrm{f}(x) = 36x - x^2$. Using the method of completing the square, find the coordinates of the vertex of the graph of $y = \\mathrm{f}(x)$. <span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">The length of a piece of string is $108\\text{ m}$. A guard cuts the string into two pieces. One piece is used to enclose a rectangular restricted zone of area $A\\text{ m}^2$. The other piece of length $x\\text{ m}$ is used to divide this restricted zone into two rectangular regions as shown in the figure.<img src="img/2013dsep1q17b.jpg" class="q-img" alt="題目附圖" style="max-width: 60%;"></div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">Express $A$ in terms of $x$. </div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">The guard claims that the area of this restricted zone can be greater than $500\\text{ m}^2$. Do you agree? Explain your answer. <br><span class="marks">(4 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 配方求頂點。 <br>(b) 用周界關係表 $A$，再求最大值。 `,
            en: `(a) Complete the square to find the vertex. <br>(b) Express $A$ using perimeter relations, then find the maximum value.`
        },
    ...
    },
    {
        ...
        content: {
            ...
            en: `<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Figure (a) shows a piece of triangular paper card $ABC$ with $AB = 28\\text{ cm}$, $BC = 21\\text{ cm}$ and $AC = 35\\text{ cm}$. Let $M$ be a point lying on $AC$ such that $\\angle BMC = 75^\\circ$.<img src="img/2013dsep1q18a.jpg" class="q-img" alt="題目附圖" style="max-width: 55%;"><div style="text-align: center;">Figure (a)</div>Find</div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">$\\angle BCM$,</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">$CM$.<br><span class="marks">(3 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">Peter folds the triangular paper card described in (a) along $BM$ such that $AB$ and $BC$ lie on the horizontal ground as shown in Figure (b). It is given that $\\angle AMC = 107^\\circ$.<img src="img/2013dsep1q18b.jpg" class="q-img" alt="題目附圖" style="max-width: 95%;"><div style="text-align: center;">Figure (b)</div></div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">Find the distance between $A$ and $C$ on the horizontal ground.</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">Let $N$ be a point lying on $BC$ such that $MN$ is perpendicular to $BC$. Peter claims that the angle between the face $BCM$ and the horizontal ground is $\\angle ANM$. Do you agree? Explain your answer. <br><span class="marks">(5 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `<a href="https://www.geogebra.org/m/gE3bg8S2" target="_blank">Geogebra 動態模型</a><br>(a) 用餘弦公式及正弦公式。 <br>(b) 用三角求距離，檢查交角定義。 `,
            en: `<a href="https://www.geogebra.org/m/gE3bg8S2" target="_blank">Geogebra Dynamic Model</a><br>(a) Use the cosine rule and sine rule. <br>(b) Use trigonometry to find the distance, and check the definition of the angle between two planes.`
        },
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-num2">(i)</div><div class="ms-content ms-from-l3">留意 $\\angle ABC=90^\\circ$。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$\\tan\\angle BCM=\\dfrac{28}{21}$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$\\angle BCM\\approx 53.13010235^\\circ$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$\\angle BCM\\approx 53.1^\\circ$</div><div class="ms-mark">1A</div></div><div class="ms-row"><div class="ms-num2">(ii)</div><div class="ms-content ms-from-l3">藉正弦公式，</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$\\dfrac{CM}{\\sin\\angle MBC}=\\dfrac{BC}{\\sin\\angle BMC}$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">$\\dfrac{CM}{\\sin(180^\\circ-75^\\circ-53.13010235^\\circ)}\\approx\\dfrac{21}{\\sin 75^\\circ}$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$CM\\approx 17.10154643\\text{ cm}$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$CM\\approx 17.1\\text{ cm}$</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num1">(b)</div><div class="ms-num2">(i)</div><div class="ms-content ms-from-l3">藉餘弦公式，</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$AC^2=AM^2+CM^2-2(AM)(CM)\\cos\\angle AMC$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">$AC\\approx 28.13898297\\text{ cm}$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$AC\\approx 28.1\\text{ cm}$</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num2">(ii)</div><div class="ms-content ms-from-l3">    $CN$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$=CM\\cos\\angle BCM$ ......<sup>@</sup></div><div class="ms-mark">1M<sup>@</sup></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$\\approx 17.10154643\\cos 53.13010235^\\circ$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$\\approx 10.26092786$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">藉餘弦公式，<br>$AB^2=AC^2+BC^2-2(AC)(BC)\\cos\\angle ACB$ ......<sup>@</sup></div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$\\angle ACB\\approx 67.6818202^\\circ$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">藉餘弦公式，<br>$AN^2=CN^2+AC^2-2(CN)(AC)\\cos\\angle ACB$ ......<sup>@</sup></div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$AN\\approx 26.03453787$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">藉正弦公式，<br>$\\dfrac{AC}{\\sin\\angle ANC}=\\dfrac{AN}{\\sin\\angle ACN}$<br>$\\angle ANC\\approx 89.06498097^\\circ$  或  $\\angle ANC\\approx 90.93501903^\\circ$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">故此，$\\angle ANC$ 不是直角。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">由此，$\\angle ANM$ 不是面 $BCM$ 與水平地面間的交角。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">因此，不同意該宣稱。</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-content ms-from-l3"><span style="background-color: #42b4ff;">另解 1：</span><br>    $CN$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$=CM \\cos \\angle BCM$ ......<sup>@</sup></div><div class="ms-mark">1M<sup>@</sup></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$\\approx 17.10154643 \\cos 53.13010235^\\circ$<br>$\\approx 10.26092786$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">藉餘弦公式，<br>$AB^2 = BC^2 + AC^2 - 2(AC)(BC)\\cos \\angle ACB$ ......<sup>@</sup><br>$\\cos \\angle ACB \\approx \\dfrac{21^2 + (28.13898297)^2 - 28^2}{2(28.13898297)(21)}$<br>$\\angle ACB \\approx 67.6818202^\\circ$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">藉餘弦公式，<br>$AN^2 = CN^2 + AC^2 - 2(CN)(AC)\\cos \\angle ACB$ ......<sup>@</sup><br>$AN^2 \\approx (10.26092786)^2 + (28.13898297)^2 - 2(10.260927867)(28.13898297)\\cos 67.6818202^\\circ$<br>$AN \\approx 26.03453787$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">$CN^2 + AN^2 \\approx (10.26092786)^2 + (26.03453787)^2$<br>$CN^2 + AN^2 \\approx 783.0838027$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">$AC^2 \\approx (28.13898297)^2$<br>$AC^2 \\approx 791.8023627$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">由此，可得 $CN^2 + AN^2 \\neq AC^2$ 。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">故此， $\\angle ANC$ 不是直角。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">所以， $\\angle ANM$ 不是面 $BCM$ 與水平地面間的交角。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">因此，不同意該宣稱。</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-content ms-from-l3"><span style="background-color: #42b4ff;">另解 2：</span><br>    $CN$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$=CM \\cos \\angle BCM$ ......<sup>@</sup></div><div class="ms-mark">1M<sup>@</sup></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$\\approx 17.10154643 \\cos 53.13010235^\\circ$<br>$\\approx 10.26092786$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">藉餘弦公式，<br>$AB^2 = BC^2 + AC^2 - 2(AC)(BC)\\cos \\angle ACB$ ......<sup>@</sup><br>$\\cos \\angle ACB \\approx \\dfrac{21^2 + (28.13898297)^2 - 28^2}{2(28.13898297)(21)}$<br>$\\cos \\angle ACB \\approx 0.379749707$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">假定 $N'$ 為由 $A$ 至 $BC$ 的垂足。<br>    $CN'$<br>$=AC \\cos \\angle ACB$ ......<sup>@</sup><br>$\\approx. 28.13898297(0.379749707)$<br>$\\approx 10.68577054$<br>由此，可得 $CN' \\neq CN$ 。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">故此，$N$ 不是由 $A$ 至 $BC$ 的垂足。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">所以， $\\angle ANM$ 不是面 $BCM$ 與水平地面間的交角。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">因此，不同意該宣稱。</div><div class="ms-mark">1A</div></div></div>`
    },
    {
    ...
    <tr>
      ...
      <td style="border: 1px solid #000; text-align: center; padding: 3px 10px;">$1.063 \\times 10^7$</td>
            ...
            en: `The development of public housing in a city is under study. It is given that the total floor area of all public housing flats at the end of the $1\\text{st}$ year is $9 \\times 10^6\\text{ m}^2$ and in subsequent years, the total floor area of public housing flats built each year is $r\\%$ of the total floor area of all public housing flats at the end of the previous year, where $r$ is a constant, and the total floor area of public housing flats pulled down each year is $3 \\times 10^5\\text{ m}^2$. It is found that the total floor area of all public housing flats at the end of the $3\\text{rd}$ year is $1.026 \\times 10^7\\text{ m}^2$.<div class="q-line"><span class="q-label">(a)</span><span class="q-label">(i)</span><div class="q-text-content">Express, in terms of $r$, the total floor area of all public housing flats at the end of the $2\\text{nd}$ year.</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">Find $r$.<br><span class="marks">(4 marks)</span></div></div><div class="q-clearfix"></div><div class="q-line"><span class="q-label">(b)</span><span class="q-label">(i)</span><div class="q-text-content">Express, in terms of $n$, the total floor area of all public housing flats at the end of the $n\\text{th}$ year.</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">At the end of which year will the total floor area of all public housing flats first exceed $4 \\times 10^7\\text{ m}^2$? <br><span class="marks">(5 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(c)</span><div class="q-text-content">It is assumed that the total floor area of public housing flats needed at the end of the $n\\text{th}$ year is $(a(1.21)^n + b)\\text{ m}^2$, where $a$ and $b$ are constants. Some research results reveal the following information:<table class="q-table" style="margin-top: 12px; margin-bottom: 12px; margin-left: auto; margin-right: auto; min-width: 300px; border-collapse: collapse; table-layout: auto;">
    <colgroup>
      <col style="width: 3em;">
      <col style="width: auto;">
    </colgroup>
    <tr>
      <td style="border: 1px solid #000; text-align: center; padding: 3px 10px;">$n$</td>
      <td style="border: 1px solid #000; text-align: center; padding: 3px 10px;">The total floor area of public housing flats needed at the end of the $n\\text{th}$ year ($\\text{m}^2$)</td>
    </tr>
	<tr>
      <td style="border: 1px solid #000; text-align: center; padding: 3px 10px;">1</td>
      <td style="border: 1px solid #000; text-align: center; padding: 3px 10px;">$1 \\times 10^7$</td>
  ...
  </table>A research assistant claims that based on the above assumption, the total floor area of all public housing flats will be greater than the total floor area of public housing flats needed at the end of a certain year. Is the claim correct? Explain your answer. <span class="marks">(4 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 寫遞推關係求 $r$。 <br>(b) 求通項後解不等式。 <br>(c) 求 $a$、$b$ 後比較兩數列。 `,
            en: `(a) Write a recurrence relation to solve for $r$. <br>(b) Find the general term and solve the inequality. <br>(c) Solve for $a$ and $b$, then compare the two sequences.`
        },
