...
D.\t$864$ cm$^2$。
    ...
    },
    {
        ...
        difficulty: 3,
        content: `圖中，$ABCD$ 為一平行四邊形及 $AEFG$ 為一正方形。已知 $BE:EF:FG = 2:7:3$。$BD$ 分別與 $AE$ 及 $FG$ 相交於點 $X$ 及點 $Y$。若 $\\triangle ABX$ 的面積為 $24$ cm$^2$，則四邊形 $CDYF$ 的面積為
<div class="q-mcopt">
A.\t$54$ cm$^2$。<br>
B.\t$77$ cm$^2$。<br>
C.\t$81$ cm$^2$。<br>
...
D.\t$248$
    ...
    },
    {
        ...
        topic: ["Areas and Volumes"],
        difficulty: 3,
        content: `圖中，$O$ 為扇形 $OABC$ 的圓心。已知 $\\triangle OAB$ 為一等邊三角形，$AC$ 與 $OB$ 相交於點 $D$。若 $OA=12$ cm 及 $\\angle AOC=90^\\circ$，求陰影區域 $BCD$ 的面積準確至最接近的 cm$^2$。
<div class="q-mcopt">
A.\t$11$ cm$^2$<br>
B.\t$16$ cm$^2$<br>
C.\t$26$ cm$^2$<br>
...
D.\t$76^\\circ$
    ...
    },
    {
        ...
        topic: ["Coordinate Geometry"],
        difficulty: 2,
        content: `若 $\\triangle ABC$ 為一直角三角形且 $\\angle ABC = 90^\\circ$，則下列何者正確？
<div class="q-mcms">
I.\t$\\triangle ABC$ 的垂心在 $AC$ 上。<br>
II.\t$\\triangle ABC$ 的形心位於 $\\triangle ABC$ 以內。<br>
III.\t$\\triangle ABC$ 的內心位於 $\\triangle ABC$ 以外。
</div>
<div class="q-mcopt">
A.\t只有 I<br>
B.\t只有 II<br>
