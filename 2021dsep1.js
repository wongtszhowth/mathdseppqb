...
<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求該分佈的平均值。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">該分佈的中位數與眾數是否相等？ 試解釋你的答案。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(c)</span><div class="q-text-content">若再多 $n$ 名小童參與該遊戲且其中每人均獲 5 個代幣，寫出</div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">$n$ 的值使得該分佈的平均值增加 1；</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">$n$ 的最小值使得該分佈的中位數增加 2；</div></div><div class="q-line q-level-2"><span class="q-label">(iii)</span><div class="q-text-content">$n$ 的最大值使得該分佈的眾數維持不變。<br><span class="marks">(3分)</span><div class="q-clearfix"></div></div></div>`,
    ...
    },
    {
        ...
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">所求的數目 $=P_{10}^{10}=3\\,628\\,800$</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num1">(b)</div><div class="ms-content ms-from-l2">    所求的概率</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=\\dfrac{7!\\cdot C_3^8\\cdot 3!}{3\\,628\\,800}$</div><div class="ms-mark">1M+1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=\\dfrac{1\\,693\\,440}{3628800}$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=\\dfrac{7}{15}$</div><div class="ms-mark">1A</div></div></div>`
    },
    {
    ...
    },
    {
        ...
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">    $\\mathrm{f}(x)$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=x^2-12kx-14x+36k^2+89k+53$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=x^2-2(6k+7)x+(6k+7)^2-(6k+7)^2+36k^2+89k+53$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=(x-6k-7)^2+5k+4$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，$Q$ 的坐標為 $(6k+7,5k+4)$。</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num1">(b)</div><div class="ms-content ms-from-l2">$(7-6k,5k+4)$</div><div class="ms-mark">1M</div></div><p><div class="ms-row"><div class="ms-num1">(c)</div><div class="ms-num2">(i)</div><div class="ms-content ms-from-l3">通過 $Q$ 及 $S$ 的直線的斜率 $=\\dfrac{5k+4-(4-3k)}{6k+7-7}=\\dfrac{4}{3}$。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">所求的方程為</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$\\dfrac{y-(4-3k)}{x-7}=\\dfrac{4}{3}$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">$4x-3y-9k-16=0$</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num2">(ii)</div><div class="ms-content ms-from-l3">設 $r$ 為 $C$ 的半徑。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">留意 $QS=RS$。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">故此，$C$ 的圓心坐標為 $(7,5k+4-r)$。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">因此，$C$ 的方程為 $(x-7)^2+(y-5k-4+r)^2=r^2$。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">把 $y=\\frac{4x-16}{3}-3k$ 代入 $(x-7)^2+(y-5k-4+r)^2=r^2$ ，</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">可得 $(x-7)^2+\\left(\\frac{4x-16}{3}-3k-5k-4+r\\right)^2=r^2$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">$25x^2+(24r-192k-350)x+576k^2-144kr+1344k-168r+1225=0$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">由於 $QS$ 為 $C$ 的切線，可得</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$(24r-192k-350)^2-4(25)(576k^2-144kr+1344k-168r+1225)=0$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">化簡後，可得 $r^2+9kr-36k^2=0$ 。<br>故此，可得  $r=3k$  或  $r=-12k$ (捨去)。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">由此， $C$ 的方程為</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$(x-7)^2+(y-5k-4+3k)^2=(3k)^2$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$(x-7)^2+(y-2k-4)^2=9k^2$</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num2">(iii)</div><div class="ms-content ms-from-l3">對於 $ST // VU$，可得 $UV$ 的斜率等於 $QS$ 的斜率。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">因此，可得 $\\dfrac{-14-(2k+4)}{-29-7}=\\dfrac{4}{3}$。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">求解後，可得 $k=15$。</div><div class="ms-mark">1A</div></div><div class="ms-row"><div class="ms-content ms-from-l3">$S$ 及 $U$ 的坐標分別為 $(7,-41)$ 及 $(7,34)$。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$SV$ 的斜率 $=\\dfrac{-14+41}{-29-7}=-\\dfrac{3}{4}$。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">故此，$QS$ 的斜率與 $SV$ 的斜率之積為 $-1$。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">因此，$ST\\perp SV$。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">由於 $ST\\perp TU$，可得 $SV // TU$。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">當 $k=15$ 時，可得  $ST // VU$ 、 $SV // TU$  及  $ST\\perp TU$ 。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">因此，$STUV$ 有可能為長方形。</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-content ms-from-l3"><span style="background-color: #42b4ff;">另解：</span><br>留意 $T$ 位於 $QS$ 上且  $QR=12k=2QT$ 。<br>由此，可得 $QT=6k$ 。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">設 $\left(t, \\frac{4t-16}{3}-3k\right)$ 為 $T$ 的坐標。<br>$(t-6k-7)^2+\\left(\\frac{4t-16}{3}-3k-5k-4\\right)^2=(6k)^2$<br>$25(t-7)^2-300k(t-7)+576k^2=0$<br>$t=\\frac{12k}{5}+7$  或  $t=\\frac{48k}{5}+7$ (捨去)<br>故此， $T$ 的坐標為 $\\left(\\frac{12k}{5}+7, \\frac{k}{5}+4\\right)$ 。</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">對 $ST=UV$ ，可得</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$\\left(\\frac{12k}{5}+7-7\\right)^2+\\left(\\frac{k}{5}+4+3k-4\\right)^2=(7+29)^2+(2k+4+14)^2$</div><div class="ms-mark">1M</div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">化簡後，可得 $12k^2-72k-1620=0$ 。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">求解後，可得  $k=15$  或  $k=-9$ (捨去)。</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">$S$ 、 $T$ 及 $U$ 的坐標分別為 $(7,-41)$ 、 $(43,7)$ 及 $(7,34)$ 。</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">$SV^2=(7+29)^2+(-14+41)^2=2\\,025$<br>$TU^2=(7+29)^2+(34-7)^2=2\\,025$<br>由此，可得 $SV=TU$ 。</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l3">另留意 $ST \\perp TU$ 。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">當 $k=15$ 時，可得  $ST=UV$ 、 $SV=TU$  及  $ST \\perp TU$ 。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">因此， $STUV$ 有可能是長方形。</div><div class="ms-mark">1A</div></div></div>`
    }
);
