...
questions.push(
    ...
    },
    {
        ...
        topic: ["Formulae"],
        difficulty: 1,
        content: `令 $a$ 成為公式 $\\frac{4-3a}{b}=5$ 的主項。<span class="marks">(3分)</span>`,
    ...
    },
    {
        ...
        topic: ["Inequalities"],
        difficulty: 2,
        content: `<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求同時滿足 $\\frac{7(x-2)}{5}+11>3(x-1)$ 及 $x+42 \\ge 0$ 的 $x$ 值的範圍。</div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">有多少個正整數同時滿足 (a) 的不等式？<span class="marks">(4分)</span><div class="q-clearfix"></div></div></div>`,
    ...
    },
    {
        ...
        difficulty: 3,
        content: `下面的棒形圖顯示一群學生在某年內的閱書數目的分佈。若從該群中隨機選出一名學生，則所選出的學生在該年內閱書少於 26 本的概率為 $\\frac{7}{10}$。<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $k$。</div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">寫出該分佈的分佈域、四分位數間距及標準差。<span class="marks">(5分)</span><div class="q-clearfix"></div></div></div><br>| 閱書數目 | 23 | 24 | 25 | 26 | 27 | 28 |<br>| :--- | :---: | :---: | :---: | :---: | :---: | :---: |<br>| 學生人數 | 12 | $k$ | 16 | 9 | 11 | 4 |`,
    ...
    },
    {
        ...
        hint: `(a) 總人數為 10 人，全排列的方法數為 $10!$。<br>(b) 「學生互不相鄰」可使用插空法。先將 7 名教師排好（$7!$），然後在教師產生的 8 個空隙中選出 3 個安排 3 名學生（$P_{3}^{8}$）。所求概率為該排列數除以總排列數。`,
    ...
    },
    {
        ...
        solution: `(a) 設等差數列的首項為 $a$，公差為 $d$。<br>$A(5) = a + 4d = 26$<br>$A(12) = a + 11d = 61$<br>兩式相減： $7d = 35 \\Rightarrow d = 5$<br>代入求得： $a = 6$<br>所以 $A(1) = 6$。<br><br>(b) 由已知 $\log_2 G(n) = A(n)$，且 $\log_8 x = \\dfrac{\log_2 x}{\log_2 8} = \\dfrac{1}{3}\log_2 x$。<br>$\log_8 (G(1)G(2)\\cdots G(k)) = \\dfrac{1}{3}\log_2(G(1)G(2)\\cdots G(k))$<br>$= \\dfrac{1}{3} [\log_2 G(1) + \log_2 G(2) + \\cdots + \log_2 G(k)]$<br>$= \\dfrac{1}{3} [A(1) + A(2) + \\cdots + A(k)] = \\dfrac{1}{3} S_k$<br>其中 $S_k$ 為等差數列的前 $k$ 項和：<br>$S_k = \\dfrac{k}{2}[2(6) + (k-1)5] = \\dfrac{k}{2}(5k + 7)$<br>代入不等式：<br>$\\dfrac{1}{3} \\cdot \\dfrac{k}{2}(5k + 7) < 999$<br>$\\dfrac{k(5k+7)}{6} < 999 \\Rightarrow 5k^2 + 7k < 5994 \\Rightarrow 5k^2 + 7k - 5994 < 0$規定利用二次方程求根公式求解 $5k^2 + 7k - 5994 = 0$：<br>$k = \\dfrac{-7 \\pm \\sqrt{7^2 - 4(5)(-5994)}}{2(5)} = \\dfrac{-7 \\pm \\sqrt{49 + 119880}}{10} = \\dfrac{-7 \\pm \\sqrt{119929}}{10} \\approx \\dfrac{-7 \\pm 346.31}{10}$<br>正根為 $k \\approx 33.93$<br>因此，滿足不等式的整數 $k$ 的範圍為 $k \\le 33$。<br>故 $k$ 的最大值為 33。`
    },
    {
    ...
    },
    {
        ...
        hint: `(a) 將 $f(x)$ 按 $x$ 的項重組為 $x^2 - 2(6k+7)x + \\cdots$，再進行配平方求出頂點式。<br>(b) $f(14-x)$ 是將圖像沿 $x=7$ 進行反射對稱變換，利用中點公式求出新的頂點 $R$。<br>(c)(i) 利用兩點式求直線 $QS$ 的方程。<br>(c)(ii) 藉由 $\triangle QRS$ 的對稱性（$S$ 點與 $Q, R$ 形成等腰三角形），求出內心 $V$ 的坐標與內切圓半徑，寫出圓方程。<br>(c)(iii) 若 $STUV$ 為長方形，則相鄰邊互相垂直且長度相等（$VT$ 為半徑）。計算各點間斜率或向量，驗證垂直與長度條件在 $k>0$ 時是否成立。`,
