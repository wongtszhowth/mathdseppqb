...
questions.push(
    ...
    },
    {
        ...
        difficulty: 4,
        content: `圓 $C$ 的方程為 $x^2+y^2-12x-16y-69=0$。 設 $G$ 為 $C$ 的圓心。 將原點記為 $O$。<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $OG$。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">$O$ 是否位於 $C$ 以內？ 試解釋你的答案。<span class="marks">(1分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(c)</span><div class="q-text-content">設 $P$ 為直角坐標平面上的一動點使得 $OP = GP$。 將 $P$ 的軌跡記為 $\\Gamma$。 假定 $\\Gamma$ 與 $C$ 相交於點 $M$ 及點 $N$。 求四邊形 $OMGN$ 的面積。<span class="marks">(4分)</span><div class="q-clearfix"></div></div></div>`,
