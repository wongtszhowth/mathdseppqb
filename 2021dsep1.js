...
questions.push(
    ...
    },
    {
        ...
        difficulty: 2,
        content: `在圖中， $AB$ 的延線與 $CD$ 的延線相交於點 $E$。 已知 $\\angle CAE = \\angle BDE$。<img src="img/2021dsep1q08.jpg" class="q-img" alt="題目附圖" style="max-width: 70%;"><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">證明 $\\Delta ACE \\sim \\Delta DBE$。<span class="marks">(2分)</span></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">已知 $AC = 25\\text{ cm}$ 、 $AE = 60\\text{ cm}$ 、 $CE = 65\\text{ cm}$ 及 $BD = 15\\text{ cm}$。</div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">$\\Delta ACE$ 是否一直角三角形？ 試解釋你的答案。</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">求 $\\Delta DBE$ 的面積。<br><span class="marks">(3分)</span><div class="q-clearfix"></div></div></div>`,
    ...
    },
    {
        ...
        difficulty: 1,
        content: `下面的棒形圖顯示一群學生在某年內的閱書數目的分佈。<img src="img/2021dsep1q09zh.jpg" class="q-img" alt="題目附圖" style="max-width: 70%;">若從該群中隨機選出一名學生，則所選出的學生在該年內閱書少於 26 本的概率為 $\\dfrac{7}{10}$。<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $k$。<span class="marks">(2分)</span></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">寫出該分佈的分佈域、四分位數間距及標準差。<span class="marks">(3分)</span><div class="q-clearfix"></div></div></div>`,
