...
已知上述分佈的分佈域為其四分位數間距的三倍。<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $w$。<span class="marks">(4分)</span></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">若從該袋子中隨機抽取一信件，求所抽取的信件的重量不少於該分佈的眾數的概率。<span class="marks">(2分)</span></div></div><div class="q-clearfix"></div>`,
        ...
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">分佈域<br>$=50+w-11$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=(w+39)$ 克</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">四分位數間距<br>$=38-23$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=15$ 克</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$w+39=3(15)$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$w=6$</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num1">(b)</div><div class="ms-content ms-from-l2">該分佈的眾數為 38 克。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">所求的概率<br>$=\\dfrac{6}{20}$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=\\dfrac{3}{10}$</div><div class="ms-mark">1A</div></div></div>`
    },
    {
