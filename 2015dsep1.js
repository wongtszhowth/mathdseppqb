...
questions.push(
    ...
    },
    {
        ...
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">    $\\mathrm{A}(1)+\\mathrm{A}(2)+\\mathrm{A}(3)+\\cdots+\\mathrm{A}(n)$<br>$=-1+3+7+\\cdots+(4n-5)$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=\\dfrac{n}{2}\\bigl((-1)+(4n-5)\\bigr)$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=n(2n-3)$</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num1">(b)</div><div class="ms-content ms-from-l2">$\\log\\bigl(\\mathrm{B}(1)\\mathrm{B}(2)\\mathrm{B}(3)\\cdots \\mathrm{B}(n)\\bigr)\\le 8000$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$\\log \\mathrm{B}(1)+\\log \\mathrm{B}(2)+\\log \\mathrm{B}(3)+\\cdots+\\log \\mathrm{B}(n)\\le 8000$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">留意對所有正整數 $k$，$\\log \\mathrm{B}(k)=\\mathrm{A}(k)$。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$\\mathrm{A}(1)+\\mathrm{A}(2)+\\mathrm{A}(3)+\\cdots+\\mathrm{A}(n)\\le 8000$</div><div class="ms-mark">1/div></div><div class="ms-row"><div class="ms-content ms-from-l2">$n(2n-3)\\le 8000$</div><div class="ms-mark">M<</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$2n^2-3n-8000\\le 0$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$(n-64)(2n+125)\\le 0$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$\\dfrac{-125}{2}\\le n\\le 64$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，$n$ 的最大值為 64。</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-content ms-from-l2"><span style="background-color: #42b4ff;">另解：</span><br>$\\log(\\mathrm{B}(1)\\mathrm{B}(2)\\mathrm{B}(3)\\cdots\\mathrm{B}(n)) \\le 8\\,000$<br>$\\log(10^{-1}~10^3~10^7~\\dots~10^{4n-5}) \\le 8\\,000$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$\\log(10^{-1+3+7+\\dots+(4n-5)}) \\le 8\\,000$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$\\log(10^{n(2n-3)}) \\le 8\\,000$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$n(2n-3) \\le 8\\,000$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$2n^2-3n-8\\,000 \\le 0$<br>$(n-64)(2n+125) \\le 0$<br>$\\dfrac{-125}{2} \\le n \\le 64$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，$n$ 的最大值為 $64$ 。</div><div class="ms-mark">1A</div></div></div>`
    },
    {
        ...
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">    $(-4k)^2-4(2)(3k^2+5)$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=16k^2-24k^2-40$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=-8k^2-40$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$&lt;0$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，$y=\\mathrm{f}(x)$ 的圖像不與 $x$ 軸相交。</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num1">(b)</div><div class="ms-content ms-from-l2">    $\\mathrm{f}(x)$<br>$=2x^2-4kx+3k^2+5$<br>$=2(x^2-2kx)+3k^2+5$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=2(x^2-2kx+k^2-k^2)+3k^2+5$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=2(x-k)^2+k^2+5$</div><div class="ms-mark">1A</div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，頂點的坐標為 $(k,k^2+5)$。</div><div class="ms-mark">1M</div></div><p><div class="ms-row"><div class="ms-num1">(c)</div><div class="ms-content ms-from-l2">藉 (b)，$y=2-\\mathrm{f}(x)$ 的圖像的頂點的坐標為 $(k,-k^2-3)$。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">當 $S$ 與 $T$ 最接近時，$S$ 及 $T$ 的坐標分別為  $(k,k^2+5)$  及  $(k,-k^2-3)$ 。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">在這情況下，$ST$ 為一垂直線。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">故此，$ST$ 的垂直平分線為一水平線。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">    $\\Delta OST$ 的外心的 $y$ 坐標</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=\\dfrac{(k^2+5)+(-k^2-3)}{2}$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=1$<br>$\\ne 0$<br>所以，$\\Delta OST$ 的外心不在 $x$ 軸上。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，該宣稱不正確。</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-content ms-from-l2"><span style="background-color: #42b4ff;">另解：</span><br>假設當 $S$ 與 $T$ 最接近時， $\\Delta OST$ 的外心在 $x$ 軸上。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">在這情況下，$S$ 及 $T$ 的坐標分別為  $(k,k^2+5)$  及  $(k,-k^2-3)$ 。</div><div class="ms-mark">1M</div></div><p><div class="ms-row"><div class="ms-content ms-from-l2">設 $(r,0)$ 為 $\\Delta OST$ 的外心 $R$ 的坐標。</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l2">    $RS$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=\\sqrt{(r-k)^2+(0-(k^2+5))^2}$ ......<sup>@</sup></div><div class="ms-mark">1M<sup>@</sup></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=\\sqrt{(r-k)^2+(k^2+5)^2}$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l2">    $RT$<br>$=\\sqrt{(r-k)^2+(0-(-k^2-3))^2}$ ......<sup>@</sup><br>$=\\sqrt{(r-k)^2+(k^2+3)^2}$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l2">故此，可得 $RS \\ne RT$ 。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">這是不可能。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，該宣稱不正確。</div><div class="ms-mark">1A</div></div></div>`
    },
    {
