...
questions.push(
    ...
    },
    {
        ...
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-content ms-from-l1"> $\\dfrac{x^{-8}y}{(x^3y)^{-6}}$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l1">$=\\dfrac{x^{-8}y}{x^{-18}y^{-6}}$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l1">$=x^{-8-(-18)}y^{1-(-6)}$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l1">$=x^{10}y^{7}$</div><div class="ms-mark">1A</div></div></div>`
    },
    {
    ...
    },
    {
        ...
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">$3x+2&gt;\\dfrac{4x-5}{2}$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$6x+4&gt;4x-5$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$6x-4x&gt;-5-4$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$2x&gt;-9$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$x&gt;\\dfrac{-9}{2}$</div><div class="ms-mark">1A</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$3x-2&lt;7$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$x&lt;3$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，我們有 $\\dfrac{-9}{2}&lt;x&lt;3$。</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num1">(b)</div><div class="ms-content ms-from-l2">4</div><div class="ms-mark">1A</div></div></div>`
    },
    {
...
該分佈的分佈域為 $27$。<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求該分佈的平均值及眾數。<span class="marks">(3分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">若從該群中隨機選出一名工人，求所選出的工人在該星期的工作時數超過該分佈的眾數的概率。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
    ...
    <tr>
      ...
      <td style="border: 1px solid #000; text-align: center; padding: 3px 10px;">1</td>
        ...
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">$\\dfrac{1(8)+2(5)+3(n)+4(1)}{8+5+n+1}=2$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$n=6$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">中位數 $=2$</div><div class="ms-mark">1A</div></div><div class="ms-row"><div class="ms-content ms-from-l2">四分位數間距 $=3-1=2$</div><div class="ms-mark">1M<br>1A</div></div><div class="ms-row"><div class="ms-content ms-from-l2">方差 $=0.9$</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num1">(b)</div><div class="ms-content ms-from-l2">留意原來的全距為 3。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">有兩種情況。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">情況 1：兩名學生各擁有 2 部計算機。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">該分佈的全距 $=3$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">情況 2：一名學生擁有 1 部計算機，另一名學生擁有 3 部計算機。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">該分佈的全距 $=3$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，因兩名學生退出，該分佈的全距沒有改變。</div><div class="ms-mark">1A</div></div></div>`
    },
    {
