...
已知該分佈的四分位數間距為 $8$ 秒。<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $c$。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">已知該分佈的分佈域超過 $34$ 秒且該分佈的平均值為 $69$ 秒。求<br><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">$a$ 及 $b$，</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">該分佈的最小可取標準差。<br><span class="marks">(6分)</span><div class="q-clearfix"></div></div></div></div></div>`,
...
<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">證明<br><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">$\\Delta BCG \\cong \\Delta CBF$，</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">$\\Delta BCF \\sim \\Delta DEF$。 <br><span class="marks">(4分)</span><div class="q-clearfix"></div></div></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">假定 $\\angle BCF = \\angle BGC$。<br><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">設 $BC = \\ell$。 以 $\\ell$ 表 $DF$。</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">某人宣稱 $AE \\gt DF$。 你是否同意？ 試解釋你的答案。 <br><span class="marks">(4分)</span><div class="q-clearfix"></div></div></div></div></div>`,
    ...
    },
    {
        ...
        difficulty: 3,
        content: `<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">設 $a$ 及 $p$ 分別為 $\\Delta CDE$ 的面積及周界。 將 $\\Delta CDE$ 的內切圓的半徑記為 $r$。 證明 $pr = 2a$。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">點 $H$ 及點 $K$ 的坐標分別為 $(9,12)$ 及 $(14,0)$。 設 $P$ 為直角坐標平面上的一動點使得由 $P$ 至 $OH$ 的垂直距離等於由 $P$ 至 $HK$ 的垂直距離，其中 $O$ 為原點。 將 $P$ 的軌跡記為 $\\mathit{\\Gamma}$。<br><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">描述 $\\mathit{\\Gamma}$ 與 $\\angle OHK$ 之間的幾何關係。</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">利用 (a)，求 $\\mathit{\\Gamma}$ 的方程。<br><span class="marks">(5分)</span><div class="q-clearfix"></div></div></div></div></div>`,
    ...
    },
    {
        ...
        <div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求<br><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">$\\angle BAD$，</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">$CP$。<br><span class="marks">(5分)</span><div class="q-clearfix"></div></div></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">該工匠宣稱 $\\angle BPC$ 為面 $ABD$ 與面 $ACD$ 間的交角。 該宣稱是否正確？ 試解釋你的答案。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
