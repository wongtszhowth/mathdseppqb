...
已知該分佈的四分位數間距為 $8$ 秒。<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $c$。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">已知該分佈的分佈域超過 $34$ 秒且該分佈的平均值為 $69$ 秒。求<br></div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">$a$ 及 $b$，</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">該分佈的最小可取標準差。<br><span class="marks">(6分)</span></div></div><div class="q-clearfix"></div>`,
    ...
    },
    {
        ...
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">把 $\\beta=5\\alpha-18$ 代入 $\\beta=\\alpha^2-13\\alpha+63$，可得</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$5\\alpha-18=\\alpha^2-13\\alpha+63$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$\\alpha^2-18\\alpha+81=0$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">求解後，可得  $\\alpha=9$  及  $\\beta=27$ 。</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num1">(b)</div><div class="ms-content ms-from-l2">設 $\\mathrm{T}(n)$ 為該等差數列的第 $n$ 項。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">由於  $\\mathrm{T}(1)=\\log 9=\\log 3^2=2\\log 3$  及  $\\mathrm{T}(2)=\\log 27=\\log 3^3=3\\log 3$ ，</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">所以該數列的公差為 $\\log 3$。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$\\mathrm{T}(1)+\\mathrm{T}(2)+\\mathrm{T}(3)+\\cdots+\\mathrm{T}(n)&gt;888$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$2\\log 3+3\\log 3+4\\log 3+\\cdots+(n+1)\\log 3&gt;888$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$\\dfrac{n}{2}\\bigl(2(2\\log 3)+(n-1)\\log 3\\bigr)&gt;888$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$(\\log 3)n^2+(3\\log 3)n-1776&gt;0$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$n&lt;-62.52928981$  或  $n&gt;59.52928981$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，$n$ 的最小值為 60。</div><div class="ms-mark">1A</div></div>
		
		<div class="ms-row"><div class="ms-content ms-from-l2"><span style="background-color: #42b4ff;">另解：</span><br>設 $\\mathrm{T}(n)$ 為該等差數列的第 $n$ 項。<br>由於  $\\mathrm{T}(1)=\\log 9=\\log 3^2$  及  $\\mathrm{T}(2)=\\log 27=\\log 3^3$ ，<br>所以該數列的公差為 $\\log 3$ 。<br>$\\mathrm{T}(1)+\\mathrm{T}(2)+\\mathrm{T}(3)+\\dots+\\mathrm{T}(n)>888$<br>$\\log 9+\\log 27+\\log 81+\\dots+\\log 3^{n+1}>888$<br>$\\log 3^2+\\log 3^3+\\log 3^4+\\dots+\\log 3^{n+1}>888$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$\\log(3^2 \\cdot 3^3 \\cdot 3^4 \\cdots 3^{n+1})>888$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$\\log(3^{2+3+4+\\dots+(n+1)})>888$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$\\log 3^{\\frac{n(n+3)}{2}}>888$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$3^{\\frac{n(n+3)}{2}}>10^{888}$<br>$\\dfrac{n(n+3)}{2}>\\log_3 10^{888}$<br>$n^2+3n-2\\log_3 10^{888}>0$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$n<-62.52928981$  或  $n>59.52928981$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，$n$ 的最小值為 $60$ 。</div><div class="ms-mark">1A</div></div>
		</div>`
    },
    {
