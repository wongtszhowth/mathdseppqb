...
questions.push(
    ...
    },
    {
        ...
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-content ms-from-l1">設 $\\$x$ 為該計算機的標價。<br>該計算機的成本</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l1">$=\\dfrac{x}{(1+40\\%)}$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l1">$=\\$\\left(\\dfrac{5x}{7}\\right)$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l1">該計算機的售價</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l1">$=(75\\%)x$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l1">$=\\$\\left(\\dfrac{3x}{4}\\right)$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l1">$\\dfrac{3x}{4}-\\dfrac{5x}{7}=13$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l1">$x=364$</div><div class="ms-mark">1A</div></div><div class="ms-row"><div class="ms-content ms-from-l1">因此，該計算機的標價為 $\\$364$。</div><div class="ms-mark"></div></div><p>另解：<br><div class="ms-row"><div class="ms-content ms-from-l1">設 $\\$c$ 為該計算機的成本。<p>該計算機的標價</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l1">$=(1+40\\%)c$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l1">$=\\$1.4c$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l1">該計算機的售價</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l1">$=(75\\%)(1.4c)$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l1">$=\\$1.05c$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l1">$1.05c-c=13$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l1">$c=260$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l1">因此，該計算機的標價為 $\\$364$。</div><div class="ms-mark">1A</div></div></div>`
    },
    {
        ...
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">$\\angle POQ$<br>$=149^\\circ-59^\\circ$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l1">$=90^\\circ$</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num1">(b)</div><div class="ms-content ms-from-l2">$\\angle POR$<br>$=239^\\circ-59^\\circ$<br>$=180^\\circ$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l1">因此，$P$、$O$ 與 $R$ 共線。</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num1">(c)</div><div class="ms-content ms-from-l2">所求的周界</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l1">$=PQ+QR+PR$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=\\sqrt{11^2+60^2}+\\sqrt{60^2+144^2}+(11+144)$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l1">$=372$</div><div class="ms-mark">1A</div></div></div>`
    },
    {
        ...
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">$\\angle ACB=\\angle ADB=90^\\circ$\t\t[已知]<br>$BC=AD$\t\t[已知]<br>$AB=AB$\t\t[公共邊]<br>$\\Delta ABC\\cong\\Delta BAD$\t\t(RHS)</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l2" style="border:1px solid #555555;padding:2px 4px;">評分標準：<br>情況 1\t附有正確理由的任何正確證明。<br>情況 2\t未附有正確理由的任何正確證明。</div><div class="ms-mark"><br>2<br>1</div></div><p><div class="ms-row"><div class="ms-num1">(b)</div><div class="ms-content ms-from-l2">$AE$<br>$=\\sqrt{AD^2+DE^2}$<br>$=15\\text{ cm}$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">藉 (a)，可得 $\\angle ABE=\\angle BAE$。<br>由此，可得 $AE=BE$。<br>故此，可得 $BE=15\\text{ cm}$。<br>留意 $CE=DE=9\\text{ cm}$。</div><div class="ms-mark">1M</div></div><p><div class="ms-row"><div class="ms-content ms-from-l2">所求的面積<br>$=\\dfrac{1}{2}(AD)(BD)+\\dfrac{1}{2}(BC)(CE)$<br>$=\\dfrac{1}{2}(12)(9+15)+\\dfrac{1}{2}(12)(9)$<br>$=198\\text{ cm}^2$</div><div class="ms-mark">1A</div></div></div>`
    },
    {
