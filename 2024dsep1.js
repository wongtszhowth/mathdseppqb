...
questions.push(
    ...
    },
    {
        ...
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">$\\dfrac{5x+7}{4}-1<2x$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$5x+7-4<8x$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$-3x<-3$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$x>1$</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-content ms-from-l2">$3x+9\\ge 0$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$x\\ge -3$</div><div class="ms-mark"></div></div><p><div class="ms-row"><div class="ms-content ms-from-l2">因此，所求的範圍為 $x>1$。</div><div class="ms-mark">1A</div></div><br><div class="ms-row"><div class="ms-num1">(b)</div><div class="ms-content ms-from-l2">2</div><div class="ms-mark">1A</div></div></div>`
    },
    {
        ...
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-content ms-from-l1">$a:c=6:5$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l1">$\\dfrac{2b+7c}{b+c}=4$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l1">$2b+7c=4b+4c$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l1">$2b=3c$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l1">$b:c=3:2$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l1">$b:c=15:10$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l1">$a:c=12:10$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l1">故此，可得 $a:b:c=12:15:10$。</div><div class="ms-mark">1M</div></div><br><div class="ms-row"><div class="ms-content ms-from-l1">設 $a=12k$ 、 $b=15k$ 及 $c=10k$ ，其中 $k$ 為一非零的常數。</div><div class="ms-mark"></div></div><br><div class="ms-row"><div class="ms-content ms-from-l1">$\\dfrac{5a+8b}{2b+3c}$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l1">$=\\dfrac{5(12k)+8(15k)}{2(15k)+3(10k)}$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l1">$=3$</div><div class="ms-mark">1A</div></div></div>`
    },
    {
