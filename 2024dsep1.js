...
因此，方程 $\\mathrm{F}(x)=0$ 有 2 個無理根。</div><div class="ms-mark">1A</div></div></div>`
    ...
    },
    {
        ...
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">   $\\mathrm{f}(x)$<br>$=2x^2+4mx+8x+2m^2+8m+n$<br>$=2(x^2+2mx+4x)+2m^2+8m+n$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=2(x^2+2(m+2)x+(m+2)^2-(m+2)^2)+2m^2+8m+n$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=2(x+m+2)^2+n-8$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，$P$ 的座標為 $(-m-2,n-8)$ 。</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num1">(b)</div><div class="ms-content ms-from-l2">$\\mathrm{f}(x)$ 變換為 $\\mathrm{f}\\left(\\dfrac{x}{5}\\right)+7$ 表示沿 $x$ 軸放大至原本的 $5$ 倍且向上平移 $7$ 單位。</div><div class="ms-mark">1A+1A</div></div><p><div class="ms-row"><div class="ms-num1">(c)</div><div class="ms-num2">(i)</div><div class="ms-content ms-from-l3">$Q$ 的座標為 $(-5m-10,n-1)$ 。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">留意 $1+n-(-m-2)=-5m-10-(1+n)$ 及 $\\dfrac{4-m}{n-8}=\\dfrac{n-1}{4-m}$ 。</div><div class="ms-mark">1M+1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">故此，可得 $n=-3m-7$ 及 $8m^2+77m+104=0$ 。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">由於 $mn<0$ ，可得 $m=-8$ 及 $n=17$ 。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">因此，$P$ 及 $Q$ 的座標分別為 $(6,9)$ 及 $(30,16)$ 。</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num2">(ii)</div><div class="ms-content ms-from-l3">對 $PQ // SR$ ，$PQ$ 的斜率等於 $RS$ 的斜率。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">所以，可得 $\\dfrac{t-(2t-3)}{3t+27-(3t+3)}=\\dfrac{16-9}{30-6}$ 。</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l3">求解後，可得 $t=-4$ 。<br>$R$ 及 $S$ 的座標分別為 $(15,-4)$ 及 $(-9,-11)$ 。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$PQ=\\sqrt{(30-6)^2+(16-9)^2}=25$ ......<sup>@</sup></div><div class="ms-mark">1M<sup>@</sup></div></div><div class="ms-row"><div class="ms-content ms-from-l3">$RS=\\sqrt{(15-(-9))^2+(-4-(-11))^2}=25 ......<sup>@</sup>$<br>$QR=\\sqrt{(30-15)^2+(16-(-4))^2}=25 ......<sup>@</sup>$<br>當 $t=-4$ 時，可得 $PQ=QR=RS$ 及 $PQ // SR$ 。</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l3">因此，$PQRS$ 有可能為一菱形。</div><div class="ms-mark">1A</div></div></div>`
    }
);
