...
questions.push(
    ...
    },
    {
        ...
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-content ms-from-l1">設 $\\$x$ 為該計算機的標價。<br>該計算機的成本<br>$=\\dfrac{x}{(1+40\\%)}$<br>$=\\$\\left(\\dfrac{5x}{7}\\right)$</div><div class="ms-mark">1M</div></div><p><div class="ms-row"><div class="ms-content ms-from-l1">該計算機的售價<br>$=(75\\%)x$<br>$=\\$\\left(\\dfrac{3x}{4}\\right)$</div><div class="ms-mark">1M</div></div><p><div class="ms-row"><div class="ms-content ms-from-l1">$\\dfrac{3x}{4}-\\dfrac{5x}{7}=13$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l1">$x=364$<br>因此，該計算機的標價為 $\\$364$。</div><div class="ms-mark">1A</div></div><p>另解：<br><div class="ms-row"><div class="ms-content ms-from-l1">設 $\\$c$ 為該計算機的成本。<p>該計算機的標價<br>$=(1+40\\%)c$<br>$=\\$1.4c$</div><div class="ms-mark">1M</div></div><p><div class="ms-row"><div class="ms-content ms-from-l1">該計算機的售價<br>$=(75\\%)(1.4c)$<br>$=\\$1.05c$</div><div class="ms-mark">1M</div></div><p><div class="ms-row"><div class="ms-content ms-from-l1">$1.05c-c=13$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l1">$c=260$<br>因此，該計算機的標價為 $\\$364$。</div><div class="ms-mark">1A</div></div></div>`
    },
    {
