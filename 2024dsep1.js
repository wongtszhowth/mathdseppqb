...
該分佈的平均值為 $30$。<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $a$ 及 $b$。<span class="marks">(3分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">寫出該分佈的最小可取分佈域。<span class="marks">(1分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(c)</span><div class="q-text-content">求該分佈的最大可取四分位數間距。<span class="marks">(3分)</span><div class="q-clearfix"></div></div></div>`,
    ...
    },
    {
        ...
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">   $X$ 的體積</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=\\dfrac{1}{3}(64^2)(24)\\left(1-\\left(\\dfrac{18}{24}\\right)^3\\right)$</div><div class="ms-mark">1M+1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=18944\\text{ cm}^3$</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num1">(b)</div><div class="ms-content ms-from-l2">   $X$ 每一側面的面積</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=\\dfrac{1}{2}\\left(64+\\dfrac{3}{4}(64)\\right)\\sqrt{6^2+8^2}$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=560\\text{ cm}^2$<p>   $X$ 的總表面面積</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=4(560)+64^2\\left(1+\\left(\\dfrac{3}{4}\\right)^2\\right)$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=8\\,640\\text{ cm}^2$<p>$\\left(\\dfrac{X\\text{ 的高}}{Z\\text{ 的高}}\\right)^2=\\left(\\dfrac{6}{3}\\right)^2=4$<br>$\\dfrac{X\\text{ 的總表面面積}}{Z\\text{ 的總表面面積}}=\\dfrac{8640}{960}=9$</div><div class="ms-mark"></div></div><div class="ms-row"><div class="ms-content ms-from-l2">$\\dfrac{X\\text{ 的總表面面積}}{Z\\text{ 的總表面面積}}\\neq\\left(\\dfrac{X\\text{ 的高}}{Z\\text{ 的高}}\\right)^2$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">因此，$X$ 與 $Z$ 不相似。</div><div class="ms-mark">1A</div></div></div>`
    },
    {
