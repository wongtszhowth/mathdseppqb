...
questions.push(
    ...
    },
    {
        ...
        solution: `<div class="ms-container"><div class="ms-row"><div class="ms-num1">(a)</div><div class="ms-content ms-from-l2">$\\angle POQ$<br>$=149^\\circ-59^\\circ$<br>$=90^\\circ$</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num1">(b)</div><div class="ms-content ms-from-l2">$\\angle POR$<br>$=239^\\circ-59^\\circ$<br>$=180^\\circ$<br>因此，$P$、$O$ 與 $R$ 共線。</div><div class="ms-mark">1A</div></div><p><div class="ms-row"><div class="ms-num1">(c)</div><div class="ms-content ms-from-l2">所求的周界<br>$=PQ+QR+PR$</div><div class="ms-mark">1M</div></div><div class="ms-row"><div class="ms-content ms-from-l2">$=\\sqrt{11^2+60^2}+\\sqrt{60^2+144^2}+(11+144)$<br>$=372$</div><div class="ms-mark">1A</div></div></div>`
    },
    {
