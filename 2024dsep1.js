...
因此，方程 $\\mathrm{F}(x)=0$ 有 2 個無理根。</div><div class="ms-mark">1A</div></div></div>`
    ...
    },
    {
        ...
        hint: `<a href="https://www.geogebra.org/m/fh3fetdc" target="_blank">Geogebra 動態模型</a><br>(a)(i) 在 $\\Delta PQS$ 中使用餘弦定理；(a)(ii) 在 $\\Delta QRS$ 中使用正弦定理；(b)(i) 利用三面角或投影關係，最短距離為 $R$ 到棱 $QS$ 的垂線長度乘以 $\\sin 80^{\\circ}$。`,
