...
questions.push(
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `令 $a$ 成為公式 $\\dfrac{3a+b}{8}=b-1$ 的主項。<span class="marks">(3分)</span>`,
            en: `Make $a$ the subject of the formula $\\dfrac{3a+b}{8}=b-1$.<span class="marks">(3 marks)</span>`
        },
        hint: {
            tc: `交叉相乘後解出 $a$。`,
            en: `Cross-multiply and solve for $a$.`
        },
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `因式分解<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">$x^2 - 6xy + 9y^2$，<span class="marks">(1分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">$x^2 - 6xy + 9y^2 + 7x - 21y$。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
            en: `Factorize<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">$x^2-6xy+9y^2$,<span class="marks">(1 mark)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">$x^2-6xy+9y^2+7x-21y$.<span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 完全平方。 <br>(b) 分組因式分解。`,
            en: `(a) Perfect square. <br>(b) Factorize by grouping.`
        },
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `<u>佩玲</u>的日薪較<u>志偉</u>高 $20\\%$，而<u>志偉</u>的日薪較<u>潔儀</u>低 $20\\%$。 已知<u>志偉</u>的日薪為 $\\$480$。 <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求<u>佩玲</u>的日薪。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">誰的日薪最高？ 試解釋你的答案。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
            en: `The daily wage of Ada is $20\\%$ higher than that of Billy while the daily wage of Billy is $20\\%$ lower than that of Christine. It is given that the daily wage of Billy is $\\$480$.<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find the daily wage of Ada.<span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">Who has the highest daily wage? Explain your answer.<span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) <u>志偉</u>日薪 $\\times 1.2$。 <br>(b) 比較三人日薪。`,
            en: `(a) Billy's daily wage $\\times 1.2$. <br>(b) Compare the daily wages of the three people.`
        },
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `在設有 $6$ 個展區的展覽中心內有 $132$ 名保安員。 各個展區均有相同人數的保安員。 在每個展區內，女保安員均較男保安員多 $4$ 名。 求在該展覽中心內男保安員的人數。 <span class="marks">(4分)</span>`,
            en: `There are $132$ guards in an exhibition centre consisting of $6$ zones. Each zone has the same number of guards. In each zone, there are $4$ more female guards than male guards. Find the number of male guards in the exhibition centre.<span class="marks">(4 marks)</span>`
        },
        hint: {
            tc: `設每展區男保安員為 $x$，列出方程。`,
            en: `Let the number of male guards in each zone be $x$, and set up an equation.`
        },
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求同時滿足  $\\dfrac{4x+6}{7} > 2(x-3)$  及  $2x-10 \\le 0$  的 $x$ 值的範圍。 <span class="marks">(3分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">有多少個正整數同時滿足 (a) 的不等式？ <span class="marks">(1分)</span><div class="q-clearfix"></div></div></div>`,
            en: `<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find the range of values of $x$ which satisfy both $\\dfrac{4x+6}{7} > 2(x-3)$ and $2x-10 \\le 0$.<span class="marks">(3 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">How many positive integers satisfy both the inequalities in (a)?<span class="marks">(1 mark)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 分別解兩個不等式後取交集。 <br>(b) 從範圍中數正整數。`,
            en: `(a) Solve both inequalities separately and find the intersection. <br>(b) Count the positive integers within the range.`
        },
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `下面的框線圖顯示某田徑學會的一大群學生完成 $100\\text{ m}$ 賽跑的所需時間的分佈：<img src="img/2012dsep1q07zh.jpg" class="q-img" alt="題目附圖" style="max-width: 70%;">該分佈的四分位數間距及分佈域分別為 $3.2\\text{ s}$ 及 $6.8\\text{ s}$。<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $a$ 及 $b$。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">該些學生參與某訓練課程。 現知在訓練後，該些學生完成 $100\\text{ m}$ 賽跑的最長所需時間較訓練前少 $2.9\\text{ s}$。 教練宣稱在訓練後，至少 $25\\%$ 的學生完成 $100\\text{ m}$ 賽跑的所需時間有改善。 你是否同意？ 試解釋你的答案。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
            en: `The box-and-whisker diagram below shows the distribution of the times taken by a large group of students of an athletic club to finish a $100\\text{ m}$ race:<img src="img/2012dsep1q07en.jpg" class="q-img" alt="題目附圖" style="max-width: 70%;">The inter-quartile range and the range of the distribution are $3.2\\text{ s}$ and $6.8\\text{ s}$ respectively.<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find $a$ and $b$.<span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">The students join a training program. It is found that the longest time taken by the students to finish a $100\\text{ m}$ race after the training is $2.9\\text{ s}$ less than that before the training. The trainer claims that at least $25\\%$ of the students show improvement in the time taken to finish a $100\\text{ m}$ race after the training. Do you agree? Explain your answer.<span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 用 IQR 及 range 求 $a$、$b$。 <br>(b) 分析上四分位數變化。`,
            en: `(a) Use IQR and range to find $a$ and $b$. <br>(b) Analyze the change in upper quartile.`
        },
    ...
    },
    {
        ...
        difficulty: 2,
        content: {
            tc: `圖中，$AB$、$BC$、$CD$ 及 $AD$ 均為圓的弦。 $AC$ 與 $BD$ 相交於 $E$。 已知 $BE = 8\\text{ cm}$ 、 $CE = 20\\text{ cm}$ 及 $DE = 15\\text{ cm}$。<img src="img/2012dsep1q08.jpg" class="q-img" alt="題目附圖" style="max-width: 50%;"><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">寫出在圖中的一對相似三角形，並求 $AE$。<span class="marks">(3分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">假定 $AB = 10\\text{ cm}$。 $AC$ 與 $BD$ 是否互相垂直？ 試解釋你的答案。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
            en: `In the figure, $AB$, $BC$, $CD$ and $AD$ are chords of the circle. $AC$ and $BD$ intersect at $E$. It is given that $BE = 8\\text{ cm}$, $CE = 20\\text{ cm}$ and $DE = 15\\text{ cm}$.<img src="img/2012dsep1q08.jpg" class="q-img" alt="題目附圖" style="max-width: 50%;"><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Write down a pair of similar triangles in the figure. Also find $AE$.<span class="marks">(3 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">Suppose that $AB = 10\\text{ cm}$. Are $AC$ and $BD$ perpendicular to each other? Explain your answer.<span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 利用相交弦定理及相似三角形。 <br>(b) 用畢氏定理檢查。`,
            en: `(a) Use intersecting chords theorem and similar triangles. <br>(b) Check using Pythagoras' theorem.`
        },
    ...
    },
    {
        ...
        difficulty: 2,
        content: {
            tc: `圖中，實心直立角柱體 $ABCDEFGH$ 的體積為 $1\\,020\\text{ cm}^3$。 該角柱體的底 $ABCD$ 為一梯形，其中 $AD$ 平行於 $BC$。 已知 $\\angle BAD = 90^\\circ$ 、 $AB = 12\\text{ cm}$ 、 $BC = 6\\text{ cm}$ 及 $DE = 10\\text{ cm}$。<img src="img/2012dsep1q09.jpg" class="q-img" alt="題目附圖" style="max-width: 55%;">求<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">$AD$ 的長度，<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">角柱體 $ABCDEFGH$ 的總表面面積。 <span class="marks">(3分)</span><div class="q-clearfix"></div></div></div>`,
            en: `In the figure, the volume of the solid right prism $ABCDEFGH$ is $1\\,020\\text{ cm}^3$. The base $ABCD$ of the prism is a trapezium, where $AD$ is parallel to $BC$. It is given that $\\angle BAD = 90^\\circ$, $AB = 12\\text{ cm}$, $BC = 6\\text{ cm}$ and $DE = 10\\text{ cm}$.<img src="img/2012dsep1q09.jpg" class="q-img" alt="題目附圖" style="max-width: 55%;">Find<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">the length of $AD$,<span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">the total surface area of the prism $ABCDEFGH$.<span class="marks">(3 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 用體積公式求 $AD$。 <br>(b) 計算各面面積總和。`,
            en: `(a) Use the volume formula to find $AD$. <br>(b) Calculate the sum of areas of all faces.`
        },
    ...
    },
    {
        ...
        difficulty: 1,
        content: {
            tc: `<u>志誠</u>進行一項中學生在某星期內用於做家課的時數的調查。 在發出的問卷中，有二十份回覆。 下面的幹葉圖顯示該二十份問卷記錄得的時數：<table class="q-table" style="border-collapse: collapse; table-layout: auto; width: auto; white-space: pre;" align="center">
    <colgroup>
    ...
    <tr>
      ...
      <td style="border-left: 1px solid black; text-align: left; padding: 0px 10px;">4 6</td>
            ...
            en: `Tom conducts a survey on the numbers of hours spent on doing homework in a week by secondary students. Questionnaires are sent out and twenty of them are returned. The stem-and-leaf diagram below shows the numbers of hours recorded in the twenty questionnaires:<table class="q-table" style="border-collapse: collapse; table-layout: auto; width: auto; white-space: pre;" align="center">
    <colgroup>
      <col style="width: auto;">
      <col style="width: auto;">
    </colgroup>
  ...
  </table><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find the mean and the median of the numbers of hours recorded in the twenty questionnaires.<span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">Tom receives four more questionnaires. He finds that the mean of the numbers of hours recorded in these four questionnaires is $18$. It is found that the numbers of hours recorded in two of these four questionnaires are $19$ and $20$.</div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">Write down the mean of the numbers of hours recorded in the twenty-four questionnaires.</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">Is it possible that the median of the numbers of hours recorded in the twenty-four questionnaires is the same as the median found in (a)? Explain your answer.<br><span class="marks">(4 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 計算總和及中位位置。 <br>(b) 求新平均值；分析中位數可能變化。`,
            en: `(a) Calculate total sum and median position. <br>(b) Find new mean; analyze potential change in median.`
        },
    ...
    },
    {
        ...
        difficulty: 2,
        content: {
            tc: `設 $\\$C$ 為一表面面積是 $A\\text{ m}^2$ 的罐的髹漆成本。 已知 $C$ 為兩部分之和，一部分為常數，而另一部分隨 $A$ 正變。 當 $A=2$ 時，$C=62$； 當 $A=6$ 時，$C=74$。<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求一表面面積是 $13\\text{ m}^2$ 的罐的髹漆成本。<span class="marks">(4分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">有一較大的罐與 (a) 所描述的罐相似。 若該較大的罐的體積為 (a) 所描述的罐的 $8$ 倍，求該較大的罐的髹漆成本。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
            en: `Let $\\$C$ be the cost of painting a can of surface area $A\\text{ m}^2$. It is given that $C$ is the sum of two parts, one part is a constant and the other part varies as $A$. When $A=2$, $C=62$; when $A=6$, $C=74$.<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find the cost of painting a can of surface area $13\\text{ m}^2$.<span class="marks">(4 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">There is a larger can which is similar to the can described in (a). If the volume of the larger can is $8$ times that of the can described in (a), find the cost of painting the larger can.<span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 設 $C = k + mA$，代入求係數。 <br>(b) 相似比為 $2$，表面積比為 $4$。`,
            en: `(a) Let $C = k + mA$, substitute to solve for coefficients. <br>(b) Linear ratio is $2$, surface area ratio is $4$.`
        },
    ...
    },
    {
        ...
        content: {
            ...
            en: `Figure (a) shows a solid metal right circular cone of base radius $48\\text{ cm}$ and height $96\\text{ cm}$.<img src="img/2012dsep1q12en.jpg" class="q-img" alt="題目附圖" style="max-width: 75%;"><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find the volume of the circular cone in terms of $\\pi$.<span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">A hemispherical vessel of radius $60\\text{ cm}$ is held vertically on a horizontal surface. The vessel is fully filled with milk.</div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">Find the volume of the milk in the vessel in terms of $\\pi$.</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">The circular cone is now held vertically in the vessel as shown in Figure (b). A craftsman claims that the volume of the milk remaining in the vessel is greater than $0.3\\text{ m}^3$. Do you agree? Explain your answer.<br><span class="marks">(5 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 用圓錐體積公式。 <br>(b) 計算半球體積減去浸入部分。`,
            en: `(a) Use the cone volume formula. <br>(b) Calculate hemisphere volume minus the submerged part.`
        },
    ...
    },
    {
        ...
        difficulty: 2,
        content: {
            tc: `<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $k$ 的值使得 $x-2$ 為 $kx^3 - 21x^2 + 24x - 4$ 的因式。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">圖中顯示 $y = 15x^2 - 63x + 72$ 的圖像。 $Q$ 為第一象限內圖像上的可變點。 $P$ 及 $R$ 分別為由 $Q$ 至 $x$ 軸及 $y$ 軸的垂足。<img src="img/2012dsep1q13b.jpg" class="q-img" alt="題目附圖" style="max-width: 60%;"></div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">設 $(m, 0)$ 為 $P$ 的坐標。 以 $m$ 表長方形 $OPQR$ 的面積。</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">$Q$ 是否有三個不同的位置使得長方形 $OPQR$ 的面積為 $12$？ 試解釋你的答案。<br><span class="marks">(5分)</span><div class="q-clearfix"></div></div></div>`,
            en: `<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find the value of $k$ such that $x-2$ is a factor of $kx^3 - 21x^2 + 24x - 4$.<span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">The figure shows the graph of $y = 15x^2 - 63x + 72$. $Q$ is a variable point on the graph in the first quadrant. $P$ and $R$ are the feet of the perpendiculars from $Q$ to the $x$-axis and the $y$-axis respectively.<img src="img/2012dsep1q13b.jpg" class="q-img" alt="題目附圖" style="max-width: 60%;"></div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">Let $(m, 0)$ be the coordinates of $P$. Express the area of the rectangle $OPQR$ in terms of $m$.</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">Are there three different positions of $Q$ such that the area of the rectangle $OPQR$ is $12$? Explain your answer.<br><span class="marks">(5 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 用因式定理求 $k$。 <br>(b) 寫面積函數後分析方程根的數目。`,
            en: `(a) Use factor theorem to find $k$. <br>(b) Write the area function and analyze the number of roots.`
        },
    ...
    },
    {
        ...
        difficulty: 3,
        content: {
            tc: `兩平行線 $L$ 及 $\\ell$ 的 $y$ 截距分別為 $-1$ 及 $-3$，且 $L$ 的 $x$ 截距為 $3$。 $P$ 為直角坐標平面上的一動點使得由 $P$ 至 $L$ 的垂直距離等於由 $P$ 至 $\\ell$ 的垂直距離。 將 $P$ 的軌跡記為 $\\mathit{\\Gamma}$。<div class="q-line"><span class="q-label">(a)</span><span class="q-label">(i)</span><div class="q-text-content">描述 $\\mathit{\\Gamma}$ 與 $L$ 之間的幾何關係。</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">求 $\\mathit{\\Gamma}$ 的方程。<br><span class="marks">(5分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">圓 $C$ 的方程為 $(x-6)^2 + y^2 = 4$。 將 $C$ 的圓心記為 $Q$。</div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">$\\mathit{\\Gamma}$ 是否通過 $Q$？ 試解釋你的答案。</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">若 $L$ 與 $C$ 相交於 $A$ 及 $B$ 而 $\\mathit{\\Gamma}$ 與 $C$ 相交於 $H$ 及 $K$，求 $\\Delta AQH$ 的面積與 $\\Delta BQK$ 的面積之比。<br><span class="marks">(4分)</span><div class="q-clearfix"></div></div></div>`,
            en: `The $y$-intercepts of two parallel lines $L$ and $\\ell$ are $-1$ and $-3$ respectively and the $x$-intercept of $L$ is $3$. $P$ is a moving point in the rectangular coordinate plane such that the perpendicular distance from $P$ to $L$ is equal to the perpendicular distance from $P$ to $\\ell$. Denote the locus of $P$ by $\\mathit{\\Gamma}$.<div class="q-line"><span class="q-label">(a)</span><span class="q-label">(i)</span><div class="q-text-content">Describe the geometric relationship between $\\mathit{\\Gamma}$ and $L$.</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">Find the equation of $\\mathit{\\Gamma}$.<br><span class="marks">(5 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">The equation of the circle $C$ is $(x-6)^2 + y^2 = 4$. Denote the centre of $C$ by $Q$.</div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">Does $\\mathit{\\Gamma}$ pass through $Q$? Explain your answer.</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">If $L$ cuts $C$ at $A$ and $B$ while $\\mathit{\\Gamma}$ cuts $C$ at $H$ and $K$, find the ratio of the area of $\\Delta AQH$ to the area of $\\Delta BQK$.<br><span class="marks">(4 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 中間平行線；求方程。 <br>(b) 代入檢查；利用對稱求面積比。`,
            en: `(a) Parallel line in between; find its equation. <br>(b) Substitute to check; use symmetry to find area ratio.`
        },
    ...
    },
    {
        ...
        difficulty: 2,
        content: {
            tc: `一班學生在某數學測驗得分的標準差為 $10$ 分。 全部學生在該測驗均不及格，故此將每名學生的測驗得分調整，使每個得分均增加 $20\\%$ 然後額外加 $5$ 分。<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求得分調整後，測驗得分的標準差。<span class="marks">(1分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">每名學生的標準分有否因得分調整而改變？ 試解釋你的答案。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
            en: `The standard deviation of the test scores obtained by a class of students in a Mathematics test is $10$ marks. All the students fail in the test, so the test score of each student is adjusted such that each score is increased by $20\\%$ and then extra $5$ marks are added.<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find the standard deviation of the test scores after the score adjustment.<span class="marks">(1 mark)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">Is there any change in the standard score of each student due to the score adjustment? Explain your answer.<span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 標準差乘以 $1.2$。 <br>(b) 分析標準分定義。`,
            en: `(a) Multiply standard deviation by $1.2$. <br>(b) Analyze the definition of standard score.`
        },
    ...
    },
    {
        ...
        difficulty: 2,
        content: {
            tc: `某公司有 $8$ 個部門。 每個部門各提名 $2$ 位代表以成立一個有 $16$ 位成員的工作小組。 從該工作小組中隨機選出 $4$ 位成員。<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求所選出的 $4$ 位成員由 $4$ 個不同部門提名的概率。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">求所選出的 $4$ 位成員至多由 $3$ 個不同部門提名的概率。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
            en: `There are $8$ departments in a company. To form a task group of $16$ members, $2$ representatives are nominated by each department. From the task group, $4$ members are randomly selected.<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find the probability that the $4$ selected members are nominated by $4$ different departments.<span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">Find the probability that the $4$ selected members are nominated by at most $3$ different departments.<span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `用組合數計算。`,
    ...
    },
    {
        ...
        difficulty: 3,
        content: {
            tc: `圓 $C$ 的圓心的坐標為 $(6,10)$。 已知 $x$ 軸為 $C$ 的切線。<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $C$ 的方程。<span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">直線 $L$ 的斜率及 $y$ 截距分別為 $-1$ 及 $k$。 若 $L$ 與 $C$ 相交於 $A$ 及 $B$，以 $k$ 表 $AB$ 的中點的坐標。<span class="marks">(5分)</span><div class="q-clearfix"></div></div></div>`,
            en: `The coordinates of the centre of the circle $C$ are $(6,10)$. It is given that the $x$-axis is a tangent to $C$.<br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find the equation of $C$.<span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">The slope and the $y$-intercept of the straight line $L$ are $-1$ and $k$ respectively. If $L$ cuts $C$ at $A$ and $B$, express the coordinates of the mid-point of $AB$ in terms of $k$.<span class="marks">(5 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 半徑為圓心到 $x$ 軸距離。 <br>(b) 求交點中點公式。`,
            en: `(a) Radius is the distance from centre to $x$-axis. <br>(b) Use the formula for the mid-point of intersection points.`
        },
    ...
    },
    {
        ...
        content: {
            ...
            en: `Figure (a) shows a right pyramid $VABCD$ with a square base, where $\\angle VAB = 72^\\circ$. The length of a side of the base is $20\\text{ cm}$. Let $P$ and $Q$ be points lying on $VA$ and $VD$ respectively such that $PQ$ is parallel to $BC$ and $\\angle PBA = 60^\\circ$. A geometric model is made by cutting off the pyramid $VPBCQ$ from $VABCD$ as shown in Figure (b).<img src="img/2012dsep1q18en.jpg" class="q-img" alt="題目附圖" style="max-width: 80%;"><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">Find the length of $AP$.<span class="marks">(2 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">Let $\\alpha$ be the angle between the plane $PBCQ$ and the base $ABCD$.</div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">Find $\\alpha$.</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">Let $\\beta$ be the angle between $PB$ and the base $ABCD$. Which one of $\\alpha$ and $\\beta$ is greater? Explain your answer.<br><span class="marks">(6 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `<a href="https://www.geogebra.org/m/zlV8yBoD" target="_blank">Geogebra 動態模型</a><br>(a) 用三角求 $AP$。 <br>(b) 求平面交角及線面交角比較。`,
            en: `<a href="https://www.geogebra.org/m/zlV8yBoD" target="_blank">Geogebra 3D Model</a><br>(a) Use trigonometry to find $AP$. <br>(b) Find the angle between planes and the angle between line and plane to compare.`
        },
    ...
    },
    {
        ...
        difficulty: 3,
        content: {
            tc: `在某城市，一機場的空運貨站 $X$ 自它開始運作起計的第 $n$ 年所處理的貨物的重量為 $\\mathrm{A}(n)$ 公噸，其中 $n$ 為一正整數。 已知 $\\mathrm{A}(n) = ab^{2n}$，其中 $a$ 及 $b$ 均為正常數。 現知 $X$ 自它開始運作起計的第 $1$ 年及第 $2$ 年所處理的貨物的重量分別為 $254\\,100$ 公噸及 $307\\,461$ 公噸。<br><div class="q-line"><span class="q-label">(a)</span><span class="q-label">(i)</span><div class="q-text-content">求 $a$ 及 $b$。<br>由此求 $X$ 自它開始運作起計的第 $4$ 年所處理的貨物的重量。</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">以 $n$ 表 $X$ 自它開始運作起計的首 $n$ 年所處理的貨物的總重量。<br><span class="marks">(6分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">自 $X$ 運作了 $4$ 年，空運貨站 $Y$ 開始運作。 設 $\\mathrm{B}(m)$ 公噸為 $Y$ 自它開始運作起計的第 $m$ 年所處理的貨物的重量，其中 $m$ 為一正整數。 已知 $\\mathrm{B}(m) = 2ab^{m}$。</div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">該機場的經理宣稱於 $Y$ 運作後，每一年 $Y$ 所處理的貨物的重量均較 $X$ 所處理的少。 你是否同意？ 試解釋你的答案。</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">該機場的監督認為當 $X$ 和 $Y$ 所處理的貨物自 $X$ 開始運作起計的總重量超出 $20\\,000\\,000$ 公噸時，應安裝新設施以維持空運貨站的工作效能。 根據該監督的想法，自 $X$ 開始運作起計的哪一年應安裝新設施？<br><span class="marks">(7分)</span><div class="q-clearfix"></div></div></div>`,
            en: `In a city, the air cargo terminal $X$ of an airport handles goods of weight $\\mathrm{A}(n)$ tonnes in the $n$th year since the start of its operation, where $n$ is a positive integer. It is given that $\\mathrm{A}(n) = ab^{2n}$, where $a$ and $b$ are positive constants. It is found that the weights of the goods handled by $X$ in the $1$st year and the $2$nd year since the start of its operation are $254\\,100$ tonnes and $307\\,461$ tonnes respectively.<br><div class="q-line"><span class="q-label">(a)</span><span class="q-label">(i)</span><div class="q-text-content">Find $a$ and $b$.<br>Hence find the weight of the goods handled by $X$ in the $4$th year since the start of its operation.</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">Express, in terms of $n$, the total weight of the goods handled by $X$ in the first $n$ years since the start of its operation.<br><span class="marks">(6 marks)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">The air cargo terminal $Y$ starts to operate since $X$ has been operated for $4$ years. Let $\\mathrm{B}(m)$ tonnes be the weight of the goods handled by $Y$ in the $m$th year since the start of its operation, where $m$ is a positive integer. It is given that $\\mathrm{B}(m) = 2ab^{m}$.</div></div><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">The manager of the airport claims that after $Y$ has been operated, the weight of the goods handled by $Y$ is less than that handled by $X$ in each year. Do you agree? Explain your answer.</div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">The supervisor of the airport thinks that when the total weight of the goods handled by $X$ and $Y$ since the start of the operation of $X$ exceeds $20\\,000\\,000$ tonnes, new facilities should be installed to maintain the efficiency of the air cargo terminals. According to the supervisor, in which year since the start of the operation of $X$ should new facilities be installed?<br><span class="marks">(7 marks)</span><div class="q-clearfix"></div></div></div>`
        },
        hint: {
            tc: `(a) 代入求 $a$、$b$；幾何級數求和。 <br>(b) 比較 $A(n)$ 與 $B(m)$；求總和超過閾值的年份。`,
            en: `(a) Substitute to find $a$ and $b$; geometric series sum. <br>(b) Compare $A(n)$ and $B(m)$; find the year when total sum exceeds threshold.`
        },
