...
questions.push(
    ...
    },
    {
        ...
        difficulty: 2,
        content: `志誠進行一項中學生在某星期內用於做家課的時數的調查。 在發出的問卷中，有二十份回覆。 下面的幹葉圖顯示該二十份問卷記錄得的時數：<br><table class="q-table"><tr><th>幹（十位）</th><th>葉（個位）</th></tr><tr><td>1</td><td>0 0 1 1 2 3 4 5 5 6 6 7 7</td></tr><tr><td>2</td><td>0 0 0 5 8</td></tr><tr><td>3</td><td>4 6</td></tr></table><br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求該二十份問卷記錄得的時數的平均值及中位數。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">志誠再收到四份問卷。 他得知這四份問卷記錄得的時數的平均值為 $18$。 現知這四份問卷其中兩份記錄得的時數為 $19$ 及 $20$。 <br><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">寫出該二十四份問卷記錄得的時數的平均值。 </div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">該二十四份問卷記錄得的時數的中位數與 (a) 所求得的中位數有沒有可能相同？ 試解釋你的答案。 <br><span class="marks">(4分)</span><div class="q-clearfix"></div></div></div></div></div>`,
    ...
    },
    {
        ...
        topic: ["Variations"],
        difficulty: 2,
        content: `設 $\$C$ 為一表面面積是 $A$ m$^2$ 的罐的髹漆成本。 已知 $C$ 為兩部分之和，一部分為常數，而另一部分隨 $A$ 正變。 當 $A=2$ 時，$C=62$；當 $A=6$ 時，$C=74$。 <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求一表面面積是 $13$ m$^2$ 的罐的髹漆成本。 <span class="marks">(4分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">有一較大的罐與 (a) 所描述的罐相似。 若該較大的罐的體積為 (a) 所描述的罐的 $8$ 倍，求該較大的罐的髹漆成本。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div>`,
    ...
    },
    {
        ...
        topic: ["Mensuration"],
        difficulty: 3,
        content: `圖 3(a) 顯示底半徑為 $48$ cm 及高為 $96$ cm 的實心金屬直立圓錐體。 <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求該圓錐體的體積，答案以 $\\pi$ 表示。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">把半徑為 $60$ cm 的半球形容器鉛垂置於一水平面上。 該容器載滿牛奶。 <br><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">求該容器內牛奶的體積，答案以 $\\pi$ 表示。 </div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">現把該圓錐體鉛垂置於該容器內，如圖 3(b) 所示。 某工匠宣稱剩下在該容器內的牛奶的體積大於 $0.3$ m$^3$。 你是否同意？ 試解釋你的答案。 <br><span class="marks">(5分)</span><div class="q-clearfix"></div></div></div></div></div>`,
    ...
    },
    {
        ...
        difficulty: 3,
        content: `<div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $k$ 的值使得 $x-2$ 為 $kx^3 - 21x^2 + 24x - 4$ 的因式。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">圖 4 顯示 $y = 15x^2 - 63x + 72$ 的圖像。 $Q$ 為第一象限內圖像上的可變點。 $P$ 及 $R$ 分別為由 $Q$ 至 $x$ 軸及 $y$ 軸的垂足。 <br><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">設 $(m, 0)$ 為 $P$ 的坐標。 以 $m$ 表長方形 $OPQR$ 的面積。 </div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">$Q$ 是否有三個不同的位置使得長方形 $OPQR$ 的面積為 $12$？ 試解釋你的答案。 <br><span class="marks">(5分)</span><div class="q-clearfix"></div></div></div></div></div>`,
    ...
    },
    {
        ...
        difficulty: 3,
        content: `兩平行線 $L$ 及 $\\ell$ 的 $y$ 截距分別為 $-1$ 及 $-3$，且 $L$ 的 $x$ 截距為 $3$。 $P$ 為直角坐標平面上的一動點使得由 $P$ 至 $L$ 的垂直距離等於由 $P$ 至 $\\ell$ 的垂直距離。 將 $P$ 的軌跡記為 $\\Gamma$。 <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content"><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">描述 $\\Gamma$ 與 $L$ 之間的幾何關係。 </div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">求 $\\Gamma$ 的方程。 <br><span class="marks">(5分)</span><div class="q-clearfix"></div></div></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">圓 $C$ 的方程為 $(x-6)^2 + y^2 = 4$。 將 $C$ 的圓心記為 $Q$。 <br><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">$\\Gamma$ 是否通過 $Q$？ 試解釋你的答案。 </div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">若 $L$ 與 $C$ 相交於 $A$ 及 $B$ 而 $\\Gamma$ 與 $C$ 相交於 $H$ 及 $K$，求 $\\triangle AQH$ 的面積與 $\\triangle BQK$ 的面積之比。 <br><span class="marks">(4分)</span><div class="q-clearfix"></div></div></div></div></div>`,
    ...
    },
    {
        ...
        difficulty: 3,
        content: `圖 5(a) 顯示以正方形為底的直立角錐體 $VABCD$，其中 $\\angle VAB = 72^\\circ$。 該底的邊長為 $20$ cm。 設 $P$ 及 $Q$ 分別為 $VA$ 及 $VD$ 上的點使得 $PQ$ 平行於 $BC$ 且 $\\angle PBA = 60^\\circ$。 從 $VABCD$ 切去角錐體 $VPBCQ$ 造成一幾何模型，如圖 5(b) 所示。 <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content">求 $AP$ 的長度。 <span class="marks">(2分)</span><div class="q-clearfix"></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">設 $\\alpha$ 為平面 $PBCQ$ 與底 $ABCD$ 間之交角。 <br><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">求 $\\alpha$。 </div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">設 $\\beta$ 為 $PB$ 與底 $ABCD$ 間之交角。 $\\alpha$ 與 $\\beta$ 哪一個較大？ 試解釋你的答案。 <br><span class="marks">(6分)</span><div class="q-clearfix"></div></div></div></div></div>`,
    ...
    },
    {
        ...
        difficulty: 3,
        content: `在某城市，一機場的空運貨站 $X$ 自它開始運作起計的第 $n$ 年所處理的貨物的重量為 $A(n)$ 公噸，其中 $n$ 為一正整數。 已知 $A(n) = ab^{2n}$，其中 $a$ 及 $b$ 均為正常數。 現知 $X$ 自它開始運作起計的第 $1$ 年及第 $2$ 年所處理的貨物的重量分別為 $254100$ 公噸及 $307461$ 公噸。 <br><div class="q-line"><span class="q-label">(a)</span><div class="q-text-content"><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">求 $a$ 及 $b$。 <br>由此求 $X$ 自它開始運作起計的第 $4$ 年所處理的貨物的重量。 </div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">以 $n$ 表 $X$ 自它開始運作起計的首 $n$ 年所處理的貨物的總重量。 <br><span class="marks">(6分)</span><div class="q-clearfix"></div></div></div></div></div><div class="q-line"><span class="q-label">(b)</span><div class="q-text-content">自 $X$ 運作了 $4$ 年，空運貨站 $Y$ 開始運作。 設 $B(m)$ 公噸為 $Y$ 自它開始運作起計的第 $m$ 年所處理的貨物的重量，其中 $m$ 為一正整數。 已知 $B(m) = 2ab^{2m}$。 <br><div class="q-line q-level-2"><span class="q-label">(i)</span><div class="q-text-content">該機場的經理宣稱於 $Y$ 運作後，每一年 $Y$ 所處理的貨物的重量均較 $X$ 所處理的少。 你是否同意？ 試解釋你的答案。 </div></div><div class="q-line q-level-2"><span class="q-label">(ii)</span><div class="q-text-content">該機場的監督認為當 $X$ 和 $Y$ 所處理的貨物自 $X$ 開始運作起計的總重量超出 $20\\,000\\,000$ 公噸時，應安裝新設施以維持空運貨站的工作效能。 根據該監督的想法，自 $X$ 開始運作起計的哪一年應安裝新設施？ <br><span class="marks">(7分)</span><div class="q-clearfix"></div></div></div></div></div>`,
